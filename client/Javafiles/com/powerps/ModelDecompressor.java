...
public class ModelDecompressor {
    ...
    public static void loadModels() {
        try {
            DataInputStream indexFile = new DataInputStream(new FileInputStream("C:/1InsanityX/Data/474ObjectModels.idx"));
            DataInputStream dataFile = new DataInputStream(new FileInputStream("C:/1InsanityX/Data/474ObjectModels.dat"));
