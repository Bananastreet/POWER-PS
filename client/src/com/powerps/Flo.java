    ...
    private void readValues(Stream stream) {
        do {
            ...
            if (i == 1) {
                ...
                if (anInt390 == 0x35720A || anInt390 == 0x50680B || anInt390 == 0x78680B || anInt390 == 0x6CAC10 || anInt390 == 0x819531)//whitefloors
                    anInt390 = 0xffffff;//end
                method262(anInt390);
                ...
                System.out.println((new StringBuilder()).append("Error unrecognised config code: ").append(i).toString());
            }
        } while (true);
    }
