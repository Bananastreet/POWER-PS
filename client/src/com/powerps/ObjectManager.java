...
final class ObjectManager {
	...
	public final void method171(CollisionMap aclass11[],
	...
	public void method175(int i, WorldController worldController,
			CollisionMap class11, int j, int k, int l, int i1, int j1) {
	...
	public final void method179(int i, int j, CollisionMap aclass11[], int l,
	...
	public final void method183(CollisionMap aclass11[],
	...
	public static void method188(WorldController worldController, int i, int j,
			int k, int l, CollisionMap class11, int ai[][][], int i1, int j1, int k1) {
		int l1 = ai[l][i1][j];
		int i2 = ai[l][i1 + 1][j];
	...
	public final void method190(int i, CollisionMap aclass11[], int j,
