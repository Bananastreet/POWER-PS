...
final class Texture extends DrawingArea {
    ...
    public static void method364() {
        ...
        originViewX = DrawingArea.width / 2;
        originViewY = DrawingArea.height / 2;
    }
        ...
        if (i <= j && i <= k) {
            ...
            if (j < k) {
                ...
                if (i != j && i8 < i7 || i == j && i8 > k7) {
                    ...
                    i = anIntArray1472[i];
                    while (--j >= 0) {
                        method379(DrawingArea.pixels, ai, i, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5,
                                k6);
                        j1 += i8;
                        l += i7;
                        i2 += j8;
                    ...
                    while (--k >= 0) {
                        method379(DrawingArea.pixels, ai, i, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5,
                                k6);
                        j1 += i8;
                        i1 += k7;
                        i2 += j8;
        ...
        if (j <= k) {
            ...
            if (k < i) {
                ...
                if (j != k && i7 < k7 || j == k && i7 > i8) {
                    ...
                    j = anIntArray1472[j];
                    while (--k >= 0) {
                        method379(DrawingArea.pixels, ai, j, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5,
                                k6);
                        l += i7;
                        i1 += k7;
                        k1 += j7;
                    ...
                    while (--i >= 0) {
                        method379(DrawingArea.pixels, ai, j, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5,
                                k6);
                        l += i7;
                        j1 += i8;
                        k1 += j7;
