            ...
            } else
            {
                ...
                if(!flag5 || !flag6)
                {
                    ...
                    for(; !flag7 && k2 < l; k2++)
                    {
                        ...
                        char ac2[] = new char[3];
                        int j3;
                        for(j3 = 0; j3 < 3 && k2 + j3 < ac.length && (!method517(ac[k2 + j3]) || ac[k2 + j3] == '\''); j3++)
                            ac2[j3] = ac[k2 + j3];
    ...
    private static int method512(char c, char c1, char c2)
    {
        ...
        if(c2 >= 'a' && c2 <= 'm')
        {
            ...
            if(c2 == 'h')
                return c1 == '#' ? 1 : 0;
            if(c2 == 'i')
                return c1 == 'y' || c1 == 'l' || c1 == 'j' || c1 == '1' || c1 == '!' || c1 == ':' || c1 == ';' || c1 == '|' ? 1 : 0;
            if(c2 == 'j')
                return 0;
            if(c2 == 'k')
                return 0;
        ...
        if(c2 >= 'n' && c2 <= 'z')
        {
            ...
            if(c2 == 'o')
                if(c1 == '0' || c1 == '*')
                    ...
                    return c1 == '(' && c == ')' || c1 == '[' && c == ']' || c1 == '{' && c == '}' || c1 == '<' && c == '>' ? 2 : 0;
            if(c2 == 'p')
                return 0;
            if(c2 == 'q')
                return 0;
