...
public final class Frame {
    ...
    private static Frame animationlist[][];
    ...
    public static void method528(int i) {
        animationlist = new Frame[4000][0];
    }

    public static void load_647(int file) {
        try {
            Stream stream = new Stream(
                    FileOperations.ReadFile(signlink.findcachedir() + "/Data/Animation/frames/" + file + ".dat"));
            Class18 class18 = new Class18(stream, 0);
            int k1 = stream.readUnsignedWord();
            animationlist[file] = new Frame[(int) (k1 * 1.5)];
            int ai[] = new int[500];
            int ai1[] = new int[500];
            int ai2[] = new int[500];
            int ai3[] = new int[500];
    ...
    public static void load(int file) {
        try {
            ...
            int k1 = stream.readUnsignedWord();
            animationlist[file] = new Frame[(int) ((double) k1 * 1.5D)];
            int ai[] = new int[500];
            int ai1[] = new int[500];
            int ai2[] = new int[500];
            int ai3[] = new int[500];
