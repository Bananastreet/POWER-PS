...
public class Model extends Animable {
	...
	public Model(int modelId) {
		...
		if (newmodel[modelId]) {
			method478(32, 32, 32);
			method475(0, 6, 0);
			// if(modelId == 55053 || modelId == 55054 || modelId == 55042 || modelId ==
			// 55043 || modelId == 26921 || modelId == 26920 || modelId == 44818 || modelId
			// == 44631) {
	...
	public void method470(int i) {
		...
		for (int k = 0; k < class36.anInt638; k++) {
			...
			method472(class18.anIntArray342[l], class18.anIntArrayArray343[l], class36.anIntArray640[k],
					class36.anIntArray641[k], class36.anIntArray642[k]);
		}
	...
	public void method471(int ai[], int j, int k) {
		...
		for (int j1 = 0; j1 < class36.anInt638; j1++) {
			...
			if (k1 != i1 || class18.anIntArray342[k1] == 0)
				method472(class18.anIntArray342[k1], class18.anIntArrayArray343[k1], class36.anIntArray640[j1],
						class36.anIntArray641[j1], class36.anIntArray642[j1]);
		}
	...
	public final void method482(int j, int k, int l, int i1, int j1, int k1) {
		int i = 0;
		int l1 = Texture.originViewX;
		int i2 = Texture.originViewY;
		int j2 = SINE[i];
		int k2 = COSINE[i];
		int l2 = SINE[j];
		int i3 = COSINE[j];
	...
	public final void method443(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2) {
		...
		if (i2 > 0 && aBoolean1684) {
			...
			int i6 = anInt1685 - Texture.originViewX;
			int k6 = anInt1686 - Texture.originViewY;
			...
			if (anIntArray1637 == null || anIntArray1637[k] != -1) {
				...
				if (flag && (i3 == -5000 || l3 == -5000 || k4 == -5000)) {
					...
					if ((i3 - l3) * (anIntArray1666[j2] - anIntArray1666[k1])
						...
						if (i3 < 0 || l3 < 0 || k4 < 0 || i3 > DrawingArea.centerX || l3 > DrawingArea.centerX
	...
	private final void method484(int i) {
		...
		if (i1 == 0) {
			Texture.method374(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j],
					anIntArray1665[k], anIntArray1665[l], anIntArray1634[i], anIntArray1635[i], anIntArray1636[i]);
			return;
		}
		if (i1 == 1) {
			Texture.method376(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j],
		...
		if (i1 == 2) {
			...
			Texture.method378(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j],
					anIntArray1665[k], anIntArray1665[l], anIntArray1634[i], anIntArray1635[i], anIntArray1636[i],
					anIntArray1668[l1], anIntArray1668[j2], anIntArray1668[l2], anIntArray1669[l1], anIntArray1669[j2],
					anIntArray1669[l2], anIntArray1670[l1], anIntArray1670[j2], anIntArray1670[l2], anIntArray1640[i]);
			return;
		}
		if (i1 == 3) {
			...
			Texture.method378(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j],
					anIntArray1665[k], anIntArray1665[l], anIntArray1634[i], anIntArray1634[i], anIntArray1634[i],
					anIntArray1668[i2], anIntArray1668[k2], anIntArray1668[i3], anIntArray1669[i2], anIntArray1669[k2],
					anIntArray1669[i3], anIntArray1670[i2], anIntArray1670[k2], anIntArray1670[i3], anIntArray1640[i]);
		}
	}
	...
	private final void method485(int i) {
		...
		if ((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0) {
			...
			if (l == 3) {
				if (j3 < 0 || j4 < 0 || j5 < 0 || j3 > DrawingArea.centerX || j4 > DrawingArea.centerX
						|| j5 > DrawingArea.centerX)
				...
				if (l7 == 0)
					...
					Texture.method378(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1], anIntArray1680[2],
							...
							anIntArray1670[k11], anIntArray1640[i]);
				} else if (l7 == 3) {
					int k8 = anIntArray1637[i] >> 2;
					int l9 = anIntArray1643[k8];
					int l10 = anIntArray1644[k8];
					int l11 = anIntArray1645[k8];
					Texture.method378(i7, j7, k7, j3, j4, j5, anIntArray1634[i], anIntArray1634[i], anIntArray1634[i],
							...
							anIntArray1670[l11], anIntArray1640[i]);
				}
			}
			if (l == 4) {
				if (j3 < 0 || j4 < 0 || j5 < 0 || j3 > DrawingArea.centerX || j4 > DrawingArea.centerX
						|| j5 > DrawingArea.centerX || anIntArray1678[3] < 0 || anIntArray1678[3] > DrawingArea.centerX)
					Texture.aBoolean1462 = true;
				int i8;
				if (anIntArray1637 == null)
					i8 = 0;
				...
				if (i8 == 0) {
					Texture.method374(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1], anIntArray1680[2]);
					Texture.method374(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1680[0],
				...
				if (i8 == 2) {
					...
					Texture.method378(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1680[0],
							...
							anIntArray1670[i10], anIntArray1670[i11], anIntArray1670[i12], anIntArray1640[i]);
					return;
				}
				if (i8 == 3) {
					...
					Texture.method378(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1634[i],
							...
							anIntArray1670[j10], anIntArray1670[j11], anIntArray1670[j12], anIntArray1640[i]);
				}
			}
		}
	}
