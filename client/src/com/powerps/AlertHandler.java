    ...
    public void processAlerts() {
        ...
        if (alert.active()) {
            ...
            if (!alert.isClosed() && alert.getOpacity() < 90 && alert.extraY > 0) {
                ...
                c.fancyFont.drawText(0, alert.getTitle(), alert.getY() + 16, alert.getX() + 243);
                c.fancyFont.drawText(alert.getTitleColor(), alert.getTitle(), alert.getY() + 15, alert.getX() + 242);
                c.smallFont.drawText(0, alert.getLine(1), alert.getY() + 36, alert.getX() + 243);
                c.smallFont.drawText(alert.getColor(2), alert.getLine(1), alert.getY() + 35, alert.getX() + 242);
                c.smallFont.drawText(0, alert.getLine(2), alert.getY() + 56, alert.getX() + 243);
                c.smallFont.drawText(alert.getColor(2), alert.getLine(2), alert.getY() + 55, alert.getX() + 242);
                show = true;
            }
        }
        if (remove) {
