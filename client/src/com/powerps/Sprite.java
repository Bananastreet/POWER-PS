...
public final class Sprite extends DrawingArea {
    ...
    public Sprite(int i, int j) {
        location = (new StringBuilder()).append(signlink.findcachedir()).append("Sprites/").toString();
    ...
    public Sprite(String s, int w, int h) {
        ...
        location = (new StringBuilder()).append(signlink.findcachedir()).append("/Sprites/").toString();
        try {
            Image image = Toolkit.getDefaultToolkit().createImage(Objects.requireNonNull(FileOperations.ReadFile((new StringBuilder()).append(location).append(s).append(".png").toString())));
            myWidth = w;
            myHeight = h;
            maxWidth = myWidth;
            maxHeight = myHeight;
    ...
    public Sprite(String img) {
        location = (new StringBuilder()).append(signlink.findcachedir()).append("Sprites/").toString();
        try {
            Image image = Toolkit.getDefaultToolkit().getImage((new StringBuilder()).append(location).append(img).append(".png").toString());
    ...
    public void setTransparency(int transRed, int transGreen, int transBlue) {
        for (int index = 0; index < myPixels.length; index++)
            if ((myPixels[index] >> 16 & 0xff) == transRed && (myPixels[index] >> 8 & 0xff) == transGreen && (myPixels[index] & 0xff) == transBlue)
                myPixels[index] = 0;
    ...
    public void method345() {
        ...
        for (int j = 0; j < myHeight; j++)
            System.arraycopy(myPixels, j * myWidth, ai, j + yDrawOffset * maxWidth + xDrawOffset, myWidth);
    ...
    private void method349(int ai[], int ai1[], int j, int k, int l, int i1, int j1,
                           int k1) {
        int l1 = -(l >> 2);
        l = -(l & 3);
    ...
    private void method351(int i, int j, int ai[], int ai1[], int l, int i1, int j1,
                           int k1, int l1) {
        int j2 = 256 - k1;
    ...
    public void drawRotatableSprite(int i, int j, int ai[], int k, int ai1[], int i1, int j1,
    ...
    private void method355(int ai[], int i, byte abyte0[], int j, int ai1[], int k, int l,
