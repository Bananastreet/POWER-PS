...
public class SmithingInterface {
	...
	private void makeRuneInterface(Client c) {
		...
		c.getPA().sendFrame126(oneb+"1 Bar"+oneb, 1067);
		...
		c.getPA().sendFrame34(1213,0,1119,1); //dagger
		 ...
		 c.getPA().sendFrame34(1115,1,1121,1); //platelegs
		 c.getPA().sendFrame34(1153,1,1122,1); //full helm
		 ...
		 c.getPA().sendFrame34(1067,3,1121,1); //platebody
