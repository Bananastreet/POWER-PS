...
public class cheart {
        ...
        public static int PresentID = 744;//Just incase I want a different box id.
                ...
                if(randomReward >= 0 && randomReward <= 60){//For all common items..
                        ...
                        amountToGive = UltraRareRewards[rewardRoll][1];
							...
							if (Server.playerHandler.players[z] != null) {
								...
								o.sendMessage("<col=16711680>["+Misc.optimizeText(c.playerName)+"]</col> <col=16713983>has just received a Ultra very rare loot from Crystal Heart!");
							}
						}
                }
