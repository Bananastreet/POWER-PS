...
public class MysteryBox {
	...
	private static int[][] commonRewards = { { 4067, 1 }, //
	...
	private static int[][] uncommonRewards = { { 4067, 1 }, //
			{ 16425, 1 }, //
			{ 14484, 1 }, //
			{ 11638, 1 },//
	};
	private static int[][] rareRewards = { { 20089, 1 }, //
			{ 20088, 1 }, //
			{ 20093, 1 }, //
			{ 6199, 1 },//
	};
	private static int[][] veryRareRewards = { { 990, 10 }, //
			{ 15017, 1 }, //
			{ 11144, 1 }, //
			{ 19931, 1 },//
	};
	private static int[][] UltraRareRewards = { { 962, 1 },//
	};
	...
	public static void openBox(Client c) {
		...
		if (randomReward >= 0 && randomReward <= 60) {// For all common items..
			...
			PlayerHandler.sendGlobalMessage("<col=29184>[" + Misc.optimizeText(c.playerName) + "]</col> <col=800000000>has just received a christmas cracker from mystery box!");
		}
