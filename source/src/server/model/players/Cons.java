...
public class Cons {
		...
		Server.getTaskScheduler().addEvent(new Task(5, false) {
			public void execute() {
				...
				if (c.playerLevel[23] > 67) {
					if (c.getItems().playerHasItem(1539, 300) && c.getItems().playerHasItem(561, 100)
							&& c.getItems().playerHasItem(556, 100) && c.getItems().playerHasItem(554, 100)
							&& c.getItems().playerHasItem(555, 100) && c.getItems().playerHasItem(557, 100)) {
						...
						c.sendMessage(
								"You need 300 Steel Nails, 1 hammer, 100 Air, Nature, Water, Fire and Earth runes.");
						this.stop();
					}
				}
				if (c.disconnected) {
	...
	public static void BuildHurryDurryCrystalCuzGabbeIsBAAAWS(final Client c) {
		...
		Server.getTaskScheduler().addEvent(new Task(5, false) {
			public void execute() {
				...
				if (c.playerLevel[23] > 67) {
					if (c.getItems().playerHasItem(1539, 80) && c.getItems().playerHasItem(8007, 100)
							&& c.getItems().playerHasItem(8009, 100) && c.getItems().playerHasItem(8010, 100)) {
						c.startAnimation(898);
	...
	public static void BuildLecterFuckersss(final Client c) {
		...
		Server.getTaskScheduler().addEvent(new Task(5, false) {
			public void execute() {
				...
				if (c.playerLevel[23] > 67) {
					if (c.getItems().playerHasItem(1539, 54) && c.getItems().playerHasItem(561, 27)
		...
		Server.getTaskScheduler().addEvent(new Task(5, false) {
			public void execute() {
				...
				if (c.playerLevel[23] > 94) {
					if (c.getItems().playerHasItem(1539, 40) && c.getItems().playerHasItem(8782, 2)
	...
	public static void BuildAltar(final Client c) {
		...
		Server.getTaskScheduler().addEvent(new Task(5, false) {
			public void execute() {
				...
				if (c.playerLevel[23] > 63) {
					if (c.getItems().playerHasItem(1539, 15) && c.getItems().playerHasItem(8782, 1)
							&& c.getItems().playerHasItem(8782, 1) && c.getItems().playerHasItem(2351, 1)) {
						c.startAnimation(898);
	...
	public static void HandleConstructionInterface(final Client c, int packetType, int packetSize) {
		...
		case 122022:// tree
			...
			if (!c.getItems().playerHasItem(1511, 1) && !c.getItems().playerHasItem(1511, 1)
		...
		case 122025: // chair
			...
			if (!c.getItems().playerHasItem(1539, 10) && !c.getItems().playerHasItem(8778, 1)
		...
		case 122028:// bookcase
			...
			if (!c.getItems().playerHasItem(1539, 15) && !c.getItems().playerHasItem(8778, 1)
					&& !c.getItems().playerHasItem(8778, 1) && !c.getItems().playerHasItem(8778, 1)) {
				c.sendMessage("You don't have the required materials!");
		...
		case 122046:// teak drawers
			...
			if (c.getItems().playerHasItem(1539, 20) && c.getItems().playerHasItem(8780, 1)
		...
		case 122049:// mithril armour
			...
			if (c.getItems().playerHasItem(1159, 1) && c.getItems().playerHasItem(1121, 1)
		...
		case 122052:// adamant armour
			...
			if (c.getItems().playerHasItem(1161, 1) && c.getItems().playerHasItem(1123, 1)
		...
		case 122055:// rune armour
			...
			if (c.getItems().playerHasItem(1153, 1) && c.getItems().playerHasItem(1067, 1)
					&& c.getItems().playerHasItem(1115, 1)) {
				c.getItems().deleteItem2(1153, 1);
				c.getItems().deleteItem2(1067, 1);
				c.getItems().deleteItem2(1115, 1);
		...
		case 122058:// rune display case
			...
			if (c.getItems().playerHasItem(563, 100) && c.getItems().playerHasItem(561, 100)
					&& c.getItems().playerHasItem(8780, 1)) {
		...
		case 122076:// crystal of power
			...
			if (c.getItems().playerHasItem(1539, 15) && c.getItems().playerHasItem(565, 30)
					&& c.getItems().playerHasItem(8782, 2) && c.getItems().playerHasItem(2351, 1)) {
				c.getItems().deleteItem2(1539, 15);
				c.getItems().deleteItem2(8782, 2);
		...
		case 122079:// altar
			...
			if (c.getItems().playerHasItem(1539, 55) && c.getItems().playerHasItem(561, 100)
					&& c.getItems().playerHasItem(536, 3) && c.getItems().playerHasItem(8782, 2)) {
				...
				c.sendMessage("You don't have the required materials.");
				c.sendMessage(
						"You need 3 Dragon Bones, 100 nature runes, 2 Mahogany Planks, 1 hammer, 55 steel nails!");
			}
		...
		case 122082:// intense burners
			...
			if (c.getItems().playerHasItem(1539, 27) && c.getItems().playerHasItem(8782, 2)
					&& c.getItems().playerHasItem(564, 40) && c.getItems().playerHasItem(263, 1)) {
				...
				c.sendMessage("You don't have the required materials.");
				c.sendMessage(
						"You need 2 Mahogany Planks, 1 Clean Kwuarm, 1 Hammer, 27 Steel Nails and 40 Cosmic Runes!");
			}
		...
		case 122085:// hedge
			...
			if (c.getItems().playerHasItem(1511, 2) && c.getItems().playerHasItem(561, 11)
		...
		case 122088:// rocnar
			...
			if (c.getItems().playerHasItem(2361, 2) && c.getItems().playerHasItem(269, 2)
