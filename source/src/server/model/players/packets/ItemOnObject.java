		  ...
		  if(!c.getItems().playerHasItem(itemId, 1)) {
            return;
				...
				c.getItems().addItem(524, 1);
			        ...
			        if (itemId == 7544 && objectId == 11212) { // HERBLORE QUEST
				c.startAnimation(1670, 0);
				c.sendMessage("You use the piece on the object... The Items Have been added to your bank!");
				c.getItems().deleteItem(7544, 1);
				c.getItems().addItemToBank(15420, 10);
			} 
                                if (itemId == 7545 && objectId == 11212) { // HERBLORE QUEST
				c.startAnimation(1670, 0);
				c.sendMessage("You use the piece on the object... The Items Have been added to your bank!");
				c.getItems().deleteItem(7545, 1);
				c.getItems().addItemToBank(6833, 5);
			}
                                if (itemId == 7546 && objectId == 11212) { // HERBLORE QUEST
				c.startAnimation(1670, 0);
				c.sendMessage("You use the piece on the object... The Items Have been added to your bank!");
				c.getItems().deleteItem(7546, 1);
				c.getItems().addItemToBank(15420, 15);
			}    
