...
public class CombatAssistant {
	...
	public int[][] slayerReqs = { { 1648, 5 }, { 1612, 15 }, { 1643, 45 }, { 1618, 50 }, { 1624, 65 }, { 1610, 75 },
			{ 1613, 80 }, { 1615, 85 }, { 2783, 90 }, { 3590, 92 }, { 3591, 82 }, { 3592, 72 } };

	public boolean goodSlayer(int i) {
		for (int j = 0; j < slayerReqs.length; j++) {
			if (slayerReqs[j][0] == NPCHandler.getNpcs()[i].npcType) {
	...
	public void attackNpc(int i) {
		...
		if (c.playerEquipment[c.playerWeapon] == 20471) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 17867) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 934) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 6505) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 4453) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 3820) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 4766) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 4744) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 4782) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 4791) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 4800) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 18477) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 18381) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 18479) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 18481) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 18483) {
			c.doubleHit = true;

		}
		if (c.playerEquipment[c.playerWeapon] == 3092) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 7808) {
			c.doubleHit = true;
		}
		...
		if (c.playerEquipment[c.playerWeapon] == 20497) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 20472) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 17877) {
			c.doubleHit = true;
		}
		...
		if (c.playerEquipment[c.playerWeapon] == 3290) { // 4743
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 4743) { // 4743
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 13840) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 6944) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 19931) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 20159) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 3287) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 12230) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 12238) {
			c.doubleHit = true;
		}
		...
		if (c.playerEquipment[c.playerWeapon] == 20250) {
			c.doubleHit = true;
		}
		...
		if (c.playerEquipment[c.playerWeapon] == 18457) {
			c.doubleHit = true;
		}
		...
		if (c.playerEquipment[c.playerWeapon] == 898) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 4646) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 20299) {
			c.doubleHit = false;
		}
		if (c.playerEquipment[c.playerWeapon] == 19930) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 19939) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 3070) {
			c.doubleHit = true;
		}
		...
		if (c.playerEquipment[c.playerWeapon] == 17837) {
			c.doubleHit = false;
		}
		if (c.playerEquipment[c.playerWeapon] == 3892) {
			c.doubleHit = true;
		}
		if (c.playerEquipment[c.playerWeapon] == 20500) {
			c.doubleHit = true;
		}
		...
		if (Server.npcHandler.npcs[i] != null) {
			...
			if (Server.npcHandler.npcs[i].npcType == 1000 || Server.npcHandler.npcs[i].npcType == 1001
					|| Server.npcHandler.npcs[i].npcType == 3100 || Server.npcHandler.npcs[i].npcType == 1002
					|| Server.npcHandler.npcs[i].npcType == 1003) {
				resetPlayerAttack();
				c.stopMovement();
				return; // Bandos
			}
			...
			if (Server.npcHandler.npcs[i].npcType == 1004 || Server.npcHandler.npcs[i].npcType == 1005
					|| Server.npcHandler.npcs[i].npcType == 1006 || Server.npcHandler.npcs[i].npcType == 1007) {
				resetPlayerAttack();
				c.stopMovement();
				return; // Arma
			}
			if (Server.npcHandler.npcs[i].npcType == 1008 || Server.npcHandler.npcs[i].npcType == 1009
					|| Server.npcHandler.npcs[i].npcType == 1010 || Server.npcHandler.npcs[i].npcType == 1011) {
				resetPlayerAttack();
				c.stopMovement();
				return; // Zammy
			}
			if (Server.npcHandler.npcs[i].npcType == 1012 || Server.npcHandler.npcs[i].npcType == 1013
					|| Server.npcHandler.npcs[i].npcType == 1014 || Server.npcHandler.npcs[i].npcType == 1015) {
				resetPlayerAttack();
				c.stopMovement();
				return; // Sara
			}
			...
			if (Server.npcHandler.npcs[i].underAttackBy > 0 && Server.npcHandler.npcs[i].underAttackBy != c.playerId
					&& !Server.npcHandler.npcs[i].inMulti()) {
				c.npcIndex = 0;
			...
			/*
			 * if (Server.npcHandler.npcs[i].spawnedBy != c.playerId &&
			 * Server.npcHandler.npcs[i].spawnedBy > 0 && Server.npcHandler.npcs[i].summon
			 * != true) { resetPlayerAttack();
			 * c.sendMessage("This monster was not spawned for you."); return; } if
			 * (Server.npcHandler.npcs[i].spawnedBy != c.playerId &&
			 * Server.npcHandler.npcs[i].spawnedBy > 0) { resetPlayerAttack();
			 * c.sendMessage("This monster was not spawned for you."); return; }
			 */
			if (c.attackTimer <= 0) {
				...
				boolean usingCross = (c.playerEquipment[c.playerWeapon] == 9185
						&& c.playerEquipment[c.playerWeapon] == 20155 && c.playerEquipment[c.playerWeapon] == 4640
						&& c.playerEquipment[c.playerWeapon] == 19477 && c.playerEquipment[c.playerWeapon] == 18357);
				c.bonusAttack = 0;
				c.rangeItemUsed = 0;
				c.projectileStage = 0;
				// c.SaveGame();
				...
				if ((!c.goodDistance(c.getX(), c.getY(), Server.npcHandler.npcs[i].getX(),
						Server.npcHandler.npcs[i].getY(), 2)
						&& (usingHally() && !usingOtherRangeWeapons && !usingBow && !usingCross && !c.usingMagic))
						|| (!c.goodDistance(c.getX(), c.getY(), Server.npcHandler.npcs[i].getX(),
								Server.npcHandler.npcs[i].getY(), 4)
								&& (usingOtherRangeWeapons && !usingCross && !usingBow && !c.usingMagic))
						|| (!c.goodDistance(c.getX(), c.getY(), Server.npcHandler.npcs[i].getX(),
								Server.npcHandler.npcs[i].getY(), 1)
								&& (!usingOtherRangeWeapons && !usingHally() && !usingCross && !usingBow
										&& !c.usingMagic))
						|| ((!c.goodDistance(c.getX(), c.getY(), Server.npcHandler.npcs[i].getX(),
								Server.npcHandler.npcs[i].getY(), 8) && (usingBow || usingCross || c.usingMagic)))) {
					c.attackTimer = 2;
					return;
				}

				if (!usingCross && !usingArrows && usingBow && !(c.playerEquipment[c.playerWeapon] == 9185
				...
				if (!usingCross && !usingArrows && usingBow && !(c.playerEquipment[c.playerWeapon] == 20155
						&& (c.playerEquipment[c.playerWeapon] < 4212 || c.playerEquipment[c.playerWeapon] > 4223))) {
					c.sendMessage("You have run out of arrows!");
					c.stopMovement();
					c.npcIndex = 0;
				...
				if (usingBow || usingCross || c.usingMagic || usingOtherRangeWeapons
						|| (c.goodDistance(c.getX(), c.getY(), Server.npcHandler.npcs[i].getX(),
								Server.npcHandler.npcs[i].getY(), 2) && usingHally())) {
					c.stopMovement();
				}
				...
				if (usingOtherRangeWeapons && !c.usingMagic && !usingCross && !usingBow) { // knives, darts, etc hit
																							// delay
					c.rangeItemUsed = c.playerEquipment[c.playerWeapon];
				...
				if (c.curseActive[18]) { // SoulSplit GFX's - CAUSES CRASH
					if (c.oldNpcIndex > 0) {
						if (Server.npcHandler.npcs[c.oldNpcIndex] != null) {
							...
							/*
							 * EventManager.getSingleton().addEvent(new Event() { // CAUSES CRASH public
							 * void execute(EventContainer b) { //c.getPA().createPlayersProjectile2(nX, nY,
							 * offX, offY, 50, 50, 2263, 9, 9, - c.playerId - 1, 24, 0); b.stop(); } },
							 * 800);
							 */
						}
					}
	...
	public void delayedHit(int i) { // npc hit delay
		if (Server.npcHandler.npcs[i] != null) {
			...
			if (!c.castingMagic && c.projectileStage > 0) { // range hit damage
				...
				int damage2 = -1;
				if (c.lastWeaponUsed == 11235 || c.lastWeaponUsed == 14481 || c.lastWeaponUsed == 14482
						|| c.bowSpecShot == 1)
				...
				if (Misc.random(5) == 1 && c.lastArrowUsed == 9243 && c.playerEquipment[c.playerWeapon] == 20155
						&& c.playerEquipment[c.playerWeapon] == 19477 && c.playerEquipment[c.playerWeapon] == 4640
						&& c.playerEquipment[c.playerWeapon] == 18357) {
					ignoreDef = true;
					Server.npcHandler.npcs[i].gfx0(758);
				}
				...
				if (Misc.random(Server.npcHandler.npcs[i].defence) > Misc.random(10 + calculateRangeAttack())
						&& !ignoreDef) {
					damage = 0;
				} else if (Server.npcHandler.npcs[i].npcType == 2881 || Server.npcHandler.npcs[i].npcType == 2883
						|| Server.npcHandler.npcs[i].npcType == 3340 && !ignoreDef) {
					damage = 0;
				}

				if (Misc.random(5) == 1 && c.lastArrowUsed == 9242 && damage > 0
				...
				if (Misc.random(5) == 1 && c.lastArrowUsed == 9242 && damage > 0
						&& c.playerEquipment[c.playerWeapon] == 20155) {
					Server.npcHandler.npcs[i].gfx0(754);
					damage = Server.npcHandler.npcs[i].HP / 5;
					// c.handleHitMask(c.playerLevel[3]/10);
					c.dealDamage(c.playerLevel[3] / 10);
				...
				if (Misc.random(5) == 1 && c.lastArrowUsed == 9242 && damage > 0
						&& c.playerEquipment[c.playerWeapon] == 19477) {
					Server.npcHandler.npcs[i].gfx0(754);
					damage = Server.npcHandler.npcs[i].HP / 5;
					// c.handleHitMask(c.playerLevel[3]/10);
					c.dealDamage(c.playerLevel[3] / 10);
				...
				if (Misc.random(5) == 1 && c.lastArrowUsed == 9242 && damage > 0
						&& c.playerEquipment[c.playerWeapon] == 4640) {
					Server.npcHandler.npcs[i].gfx0(754);
					damage = Server.npcHandler.npcs[i].HP / 5;
					// c.handleHitMask(c.playerLevel[3]/10);
					c.dealDamage(c.playerLevel[3] / 10);
				...
				if (damage > 0 && Misc.random(4) == 1 && c.lastArrowUsed == 9244
						&& c.playerEquipment[c.playerWeapon] == 18357) {
					damage *= 1.45;
					Server.npcHandler.npcs[i].gfx0(756);
				}
	...
	public void applyNpcMeleeDamage(int i, int damageMask, int damage) {
		...
		if (c.fightMode == 3) {
			if (c.trade11 > 0) {
				c.getPA().addSkillXP((damage * Config.STARTER_MELEE_EXP_RATE / 3), 0);
				c.getPA().addSkillXP((damage * Config.STARTER_MELEE_EXP_RATE / 3), 1);
				c.getPA().addSkillXP((damage * Config.STARTER_MELEE_EXP_RATE / 3), 2);
				c.getPA().addSkillXP((damage * Config.STARTER_MELEE_EXP_RATE / 3), 3);
			} else {
			...
			if (c.trade11 > 0) {
				c.getPA().addSkillXP((damage * Config.STARTER_MELEE_EXP_RATE), c.fightMode);
				c.getPA().addSkillXP((damage * Config.STARTER_MELEE_EXP_RATE / 3), 3);
			} else {
			...
			if (Server.npcHandler.npcs[c.oldNpcIndex] != null) {
				...
				if (usingDbow())
					c.getPA().createPlayersProjectile2(pX, pY, offX, offY, 50, getProjectileSpeed(),
							getRangeProjectileGFX(), 60, 31, c.oldNpcIndex + 1, getStartDelay(), 35);
			}
		}
	}
	...
	public void attackPlayer(int i) {
		...
		if (c.playerEquipment[c.playerWeapon] == 15001 && 11212 != c.playerEquipment[c.playerArrows]) {
			c.sendMessage("You need dragon arrows to attack with a aiyana bow");
			return;
		}
		if (c.playerEquipment[c.playerWeapon] == 4734 && 4740 != c.playerEquipment[c.playerArrows]) {
			c.sendMessage("You need Bolt Rack for Karil's Crossbow!");
		...
		for (int u : c.Bolts) {
			for (int y : c.BOWS) {
				if (y == c.playerEquipment[c.playerWeapon] && u == c.playerEquipment[c.playerArrows]
						&& c.playerEquipment[c.playerWeapon] != 4734 && c.playerEquipment[c.playerWeapon] != 9185
						&& c.playerEquipment[c.playerWeapon] != 18357) {
		...
		if (Server.playerHandler.players[i] != null) {
			...
			if (!c.goodDistance(Server.playerHandler.players[i].getX(), Server.playerHandler.players[i].getY(),
					c.getX(), c.getY(), 25) && !sameSpot) {
				resetPlayerAttack();
				return;
			}
			...
			if (c.attackTimer <= 0) {
				...
				if ((!c.goodDistance(c.getX(), c.getY(), Server.playerHandler.players[i].getX(),
						Server.playerHandler.players[i].getY(), 4)
						&& (usingOtherRangeWeapons && !usingBow && !c.usingMagic))
						|| (!c.goodDistance(c.getX(), c.getY(), Server.playerHandler.players[i].getX(),
								Server.playerHandler.players[i].getY(), 2)
								&& (!usingOtherRangeWeapons && usingHally() && !usingBow && !c.usingMagic))
						|| (!c.goodDistance(c.getX(), c.getY(), Server.playerHandler.players[i].getX(),
								Server.playerHandler.players[i].getY(), getRequiredDistance())
								&& (!usingOtherRangeWeapons && !usingHally() && !usingBow && !c.usingMagic))
						|| (!c.goodDistance(c.getX(), c.getY(), Server.playerHandler.players[i].getX(),
				...
				if (c.duelStatus != 5 && !c.inPits && c.inWild()) {
					if (!c.attackedPlayers.contains(c.playerIndex)
							&& !Server.playerHandler.players[c.playerIndex].attackedPlayers.contains(c.playerId)) {
				...
				if (c.curseActive[10]) { // Leech Attack
					...
					if (c.oldPlayerIndex > 0) {
						if (PlayerHandler.players[c.oldPlayerIndex] != null) {
							...
							final int offX = (pY - nY) * -1;
							final int offY = (pX - nX) * -1;
							c.getPA().createPlayersProjectile2(pX, pY, offX, offY, 50, 50, 2252, 9, 9,
				...
				if (c.curseActive[13]) { // Leech Defense
					...
					if (c.oldPlayerIndex > 0) {
						if (PlayerHandler.players[c.oldPlayerIndex] != null) {
							...
							final int offX = (pY - nY) * -1;
							final int offY = (pX - nX) * -1;
							c.getPA().createPlayersProjectile2(pX, pY, offX, offY, 50, 50, 2242, 9, 9,
									-c.oldPlayerIndex - 1, 24, 0);
				...
				if (c.curseActive[14]) { // Leech Strength
					...
					if (c.oldPlayerIndex > 0) {
						if (PlayerHandler.players[c.oldPlayerIndex] != null) {
							...
							final int offX = (pY - nY) * -1;
							final int offY = (pX - nX) * -1;
							c.getPA().createPlayersProjectile2(pX, pY, offX, offY, 50, 50, 2248, 9, 9,
									-c.oldPlayerIndex - 1, 24, 0);
							c2.sendMessage(
									"Your strength has been leeched by " + Misc.optimizeText(c.playerName) + "!");
							c2.gfx0(2250);
							c.startAnimation(12575);
							c.Lstrength = false;
						}
				...
				if (c.curseActive[11]) { // Leech Ranged
					...
					if (c.oldPlayerIndex > 0) {
						if (PlayerHandler.players[c.oldPlayerIndex] != null) {
							...
							final int offX = (pY - nY) * -1;
							final int offY = (pX - nX) * -1;
							c.getPA().createPlayersProjectile2(pX, pY, offX, offY, 50, 50, 2236, 9, 9,
									-c.oldPlayerIndex - 1, 24, 0);
				...
				if (c.curseActive[12]) { // Leech Magic
					...
					if (c.oldPlayerIndex > 0) {
						if (PlayerHandler.players[c.oldPlayerIndex] != null) {
							...
							final int offX = (pY - nY) * -1;
							final int offY = (pX - nX) * -1;
							c.getPA().createPlayersProjectile2(pX, pY, offX, offY, 50, 50, 2240, 9, 9,
									-c.oldPlayerIndex - 1, 24, 0);
				...
				if (c.curseActive[16]) { // Leech Special
					...
					if (failed < 10) {
						...
						final int offX = (pY - nY) * -1;
						final int offY = (pX - nX) * -1;
						c.getPA().createPlayersProjectile2(pX, pY, offX, offY, 50, 50, 2256, 9, 9,
								-c.oldPlayerIndex - 1, 24, 0);
						c2.sendMessage(
								"Your special attack has been leeched by " + Misc.optimizeText(c.playerName) + "!");
						c2.gfx0(2258);
						c.startAnimation(12575);
						c.getItems().updateSpecialBar();
					...
					if (c.oldPlayerIndex > 0) {
						if (Server.playerHandler.players[c.oldPlayerIndex] != null) {
							try {
								...
								final int offY = (pX - nX) * -1;
								c.SSPLIT = true;
								c.getPA().createPlayersProjectile2(pX, pY, offX, offY, 50, 50, 2263, 9, 9,
										-c.oldPlayerIndex - 1, 24, 0);
				...
				if (usingBow && Config.CRYSTAL_BOW_DEGRADES) { // crystal bow degrading
					if (c.playerEquipment[c.playerWeapon] == 4212) { // new crystal bow becomes full bow on the first
																		// shot
	...
	public void playerDelayedHit(int i) {
		if (Server.playerHandler.players[i] != null) {
			if (Server.playerHandler.players[i].isDead || c.isDead
					|| Server.playerHandler.players[i].playerLevel[3] <= 0 || c.playerLevel[3] <= 0) {
				c.playerIndex = 0;
				return;
			}
			if (Server.playerHandler.players[i].respawnTimer > 0) {
			...
			/*
			 * if(c.projectileStage == 0 && !c.usingMagic && !c.castingMagic) { // melee hit
			 * damage applyPlayerMeleeDamage(i, 1, Misc.random(calculateMeleeMaxHit()));
			 * if(c.doubleHit && !c.usingClaws) { applyPlayerMeleeDamage(i, 2,
			 * Misc.random(calculateMeleeMaxHit())); } if(c.doubleHit && c.usingClaws) {
			...
			if (c.projectileStage == 0 && !c.usingMagic && !c.castingMagic) { // melee hit damage
				...
				if (c.doubleHit && c.usingClaws) {
					// System.out.println(c.clawDamage + " " + c.clawDamage/2 + " " + c.clawDamage/4
					// + " " + c.clawDamage/4 + 1);
					c.delayedDamage = c.clawDamage;
					c.delayedDamage2 = c.clawDamage / 2;
			...
			if (!c.castingMagic && c.projectileStage > 0) { // range hit damage
				...
				if (o.prayerActive[17] || o.curseActive[8] && System.currentTimeMillis() - o.protRangeDelay > 1500) { // if
																														// prayer
																														// active
																														// reduce
																														// damage
					...
					/*
					 * if (o.playerEquipment[o.playerShield] == 15023 && o.playerLevel[5] >= 1 &&
					 * damage >= 1) { damage = (int)damage * 42 / 100; damage2 = (int)damage2 * 42 /
					 * 100; o.playerLevel[5] -= PrayerDrain; o.getPA().refreshSkill(5); }
					 */
					...
					/*
					 * if (o.playerEquipment[o.playerShield] == 13742 && !o.prayerActive[17] ||
					 * !o.curseActive[8] && damage >= 1) { damage = (int)damage * 65 / 100; damage2
					 * = (int)damage2 * 65 / 100; }
					 */
					// }
				...
				if (o.playerEquipment[o.playerShield] == 15023 && !o.prayerActive[17]
						|| !o.curseActive[8] && o.playerLevel[5] >= 1 && damage >= 1) {
					// if(Misc.random(2) == 1) {
					...
					for (int j = 0; j < rangeDouble.length; j++) {
						if (damage2 != -1 && rangeDouble[j] == c.playerEquipment[c.playerWeapon]) {
							...
							Server.playerHandler.players[i].handleHitMask(damage2,
									Server.playerHandler.players[i].playerId);
				...
				if (o.prayerActive[16] || o.curseActive[7] && System.currentTimeMillis() - o.protMageDelay > 1500) { // if
																														// prayer
																														// active
																														// reduce
																														// damage
				...
				if (o.playerEquipment[o.playerShield] == 13742 && !o.prayerActive[16]
						|| !o.curseActive[7] && damage >= 1) {
					if (Misc.random(4) == 3) {
				...
				if (o.playerEquipment[o.playerShield] == 15023 && !o.prayerActive[16]
						|| !o.curseActive[7] && o.playerLevel[5] >= 1 && damage >= 1) {
					// if(Misc.random(2) == 1) {
					damage = (int) damage * 70 / 100;
					o.getPA().refreshSkill(5);
					o.playerLevel[5] -= PrayerDrain;
				...
				if (!c.magicFailed) {
					if (System.currentTimeMillis() - Server.playerHandler.players[i].reduceStat > 35000) {
						...
						case 12999:
						case 13023:
							Server.playerHandler.players[i].playerLevel[0] -= ((o.getPA()
									.getLevelForXP(Server.playerHandler.players[i].playerXP[0]) * 10) / 100);
							break;
						}
					}
					...
					case 12445: // teleblock
						if (System.currentTimeMillis() - o.teleBlockDelay > o.teleBlockLength) {
							...
							if (o.prayerActive[16]
									|| o.curseActive[7] && System.currentTimeMillis() - o.protMageDelay > 1500)
					...
					case 1153:
						Server.playerHandler.players[i].playerLevel[0] -= ((o.getPA()
								.getLevelForXP(Server.playerHandler.players[i].playerXP[0]) * 5) / 100);
					...
					case 1157:
						Server.playerHandler.players[i].playerLevel[2] -= ((o.getPA()
								.getLevelForXP(Server.playerHandler.players[i].playerXP[2]) * 5) / 100);
					...
					case 1161:
						Server.playerHandler.players[i].playerLevel[1] -= ((o.getPA()
								.getLevelForXP(Server.playerHandler.players[i].playerXP[1]) * 5) / 100);
					...
					case 1542:
						Server.playerHandler.players[i].playerLevel[1] -= ((o.getPA()
								.getLevelForXP(Server.playerHandler.players[i].playerXP[1]) * 10) / 100);
						o.sendMessage("Your defence level has been reduced!");
						Server.playerHandler.players[i].reduceSpellDelay[c.reduceSpellId] = System.currentTimeMillis();
						o.getPA().refreshSkill(1);
						break;
					...
					case 1543:
						Server.playerHandler.players[i].playerLevel[2] -= ((o.getPA()
								.getLevelForXP(Server.playerHandler.players[i].playerXP[2]) * 10) / 100);
						o.sendMessage("Your strength level has been reduced!");
						Server.playerHandler.players[i].reduceSpellDelay[c.reduceSpellId] = System.currentTimeMillis();
						o.getPA().refreshSkill(2);
						break;
				...
				if (o.inMulti() && multis()) {
					...
					for (int j = 0; j < Server.playerHandler.players.length; j++) {
						if (Server.playerHandler.players[j] != null) {
							...
							if (c.barrageCount >= 9)
								break;
							if (o.goodDistance(o.getX(), o.getY(), Server.playerHandler.players[j].getX(),
									Server.playerHandler.players[j].getY(), 1))
	...
	public int getWeaponDistance(String weaponName) {
		...
		if (weaponName.contains("dark bow")) {
			if (c.fightMode == 3) { // case 15501:
				return 13;
			} else {
				return 12;
			}
		}
		if (weaponName.contains("Aiyana bow")) {
			if (c.fightMode == 3) { // case 15501:
				return 13;
			} else {
				return 12;
			...
			if (checkMultiBarrageReqs(playerId)) {
				...
				if (Misc.random(mageAtk()) > Misc.random(mageDef()) && !c.magicFailed) {
					...
					Server.playerHandler.players[playerId].handleHitMask(damage,
							Server.playerHandler.players[playerId].playerId);
	...
	public void multiSpellOnNPC(int originalNpc) {
		...
		for (int indx = 0; indx < NPCHandler.maxNPCs; indx++) {
			if (NPCHandler.npcs[indx] != null) {
				...
				if (!(o.absX >= origX - 2 && o.absX <= origX + 2 && o.absY >= origY - 2 && o.absY <= origY + 2)
						|| !o.inMulti())
					continue;
		...
		for (int indx = 0; indx < Config.MAX_PLAYERS; indx++) {
			if (PlayerHandler.players[indx] != null) {
				...
				if (!(o.absX >= origX - 2 && o.absX <= origX + 2 && o.absY >= origY - 2 && o.absY <= origY + 2)
						|| !o.inMulti())
					continue;
				if (!checkPlayerReq(indx) || indx == originalPlayer || indx == c.playerId)
					continue;
				if (Misc.random(o.getCombat().mageDef()) > Misc.random(mageAtk())) {
					if (getEndGfxHeight() == 100) { // end GFX
						o.gfx100(c.MAGIC_SPELLS[c.oldSpellId][5]);
	...
	public boolean checkNpcReq(int i) {
		...
		if (NPCHandler.npcs[i].underAttackBy > 0 && NPCHandler.npcs[i].underAttackBy != c.playerId
				&& !NPCHandler.npcs[i].inMulti() && c.inGWD() == false) {
			c.npcIndex = 0;
	...
	public void multiSpellEffect(int playerId, int damage) {
		...
		case 13023:
			if (System.currentTimeMillis() - Server.playerHandler.players[playerId].reduceStat > 35000) {
				...
				Server.playerHandler.players[playerId].playerLevel[0] -= ((Server.playerHandler.players[playerId]
						.getLevelForXP(Server.playerHandler.players[playerId].playerXP[0]) * 10) / 100);
			}
			break;
		case 12919: // blood spells
		case 12929:
	...
	public void applyPlayerClawDamage(int i, int damageMask, int damage) {
		...
		if (o.prayerActive[18]
				|| o.curseActive[9] && System.currentTimeMillis() - o.protMeleeDelay > 1500 && !veracsEffect) { // if
																												// prayer
																												// active
																												// reduce
																												// damage
		...
		if (o.playerEquipment[o.playerShield] == 13740 && !o.prayerActive[18]
				|| !o.curseActive[9] && o.playerLevel[5] >= 1 && damage >= 1) {
			// if(Misc.random(2) == 1) {
			damage = (int) damage * 70 / 100;
			o.getPA().refreshSkill(5);
			o.playerLevel[5] -= PrayerDrain;
		...
		case 1: // dragon scimmy special
			if (damage > 0) {
				if (o.prayerActive[16] || o.prayerActive[17] || o.prayerActive[18] || o.curseActive[7]
		...
		case 1:
			 ...
			 * Server.playerHandler.players[i].setHitDiff(damage);
			 * Server.playerHandler.players[i].setHitUpdateRequired(true); } else {
		...
		case 2:
			 ...
			 * Server.playerHandler.players[i].setHitDiff2(damage);
			 * Server.playerHandler.players[i].setHitUpdateRequired2(true); } else {
			 * Server.playerHandler.players[i].setHitDiff(damage);
			 * Server.playerHandler.players[i].setHitUpdateRequired(true); }
			 */
			// Server.playerHandler.players[i].playerLevel[3] -= damage;
		...
		if (c.oldPlayerIndex > 0) {
			if (Server.playerHandler.players[c.oldPlayerIndex] != null) {
				...
				if (c.playerEquipment[c.playerWeapon] == 15241) {
					...
					c.getPA().createPlayersProjectile(pX, pY, offX, offY, 50, getProjectileSpeed(),
							getRangeProjectileGFX(), 43, 31, -c.oldPlayerIndex - 1, getStartDelay());
				else if (c.msbSpec) {
					c.msbSpec = false;
					c.getPA().createPlayersProjectile2(pX, pY, offX, offY, 50, 55, getRangeProjectileGFX(), 22, 22,
							c.oldNpcIndex + 1, getStartDelay(), -1);
				}
				if (usingDbow())
					c.getPA().createPlayersProjectile2(pX, pY, offX, offY, 50, getProjectileSpeed(),
							getRangeProjectileGFX(), 60, 31, -c.oldPlayerIndex - 1, getStartDelay(), 35);
			}
		}
	}
	...
	public void activateSpecial(int weapon, int i) {
		/*
		 * if(Server.npcHandler.npcs[i] == null && c.npcIndex > 0) { return; }
		 * if(Server.playerHandler.players[i] == null && c.playerIndex > 0) { return; }
		 */
		c.doubleHit = false;
		c.specEffect = 0;
		c.projectileStage = 0;
		...
		case 15241: // hand cannon spec!!
			...
			if (c.fightMode == 2)
				if (c.playerIndex > 0)
					...
					fireProjectileNpc();
			break;
		case 17867: // bone sword
			c.gfx100(248);
			c.startAnimation(1058);
			c.hitDelay = getHitDelay(c.getItems().getItemName(c.playerEquipment[c.playerWeapon]).toLowerCase());
			c.specAccuracy = 50.90;
			c.specDamage = 90.50;
			break;
		...
		/*
		 * case 19780: c.gfx100(1224); c.startAnimation(1872); c.specAccuracy = 7.99;
		 * c.specDamage = 1.40; c.ssSpec = true; c.hitDelay =
		 * getHitDelay(c.getItems().getItemName(c.playerEquipment[c.playerWeapon]).
		 * toLowerCase()); break;
		 */
		...
		/*
		 * case 13883: // Morrigan Throwing Axe c.usingRangeWeapon = true;
		 * c.rangeItemUsed = c.playerEquipment[c.playerArrows];
		 * c.getItems().deleteArrow(); c.lastWeaponUsed = weapon;
		 * c.startAnimation(10504); c.gfx0(1838); c.hitDelay = 3; c.specAccuracy = 1.90;
		 * c.specDamage = 1.20; c.projectileStage = 1; c.hitDelay =
		 * getHitDelay(c.getItems().getItemName(c.playerEquipment[c.playerWeapon]).
		 * toLowerCase()); if (c.fightMode == 2) c.attackTimer--; if (c.playerIndex > 0)
		 * fireProjectilePlayer(); else if (c.npcIndex > 0) fireProjectileNpc(); break;
		 */

		/*
		 * case 13879: // Morrigan Javelin c.usingRangeWeapon = true; c.rangeItemUsed =
		 * c.playerEquipment[c.playerArrows]; c.getItems().deleteArrow();
		 * c.lastWeaponUsed = weapon; c.startAnimation(10501); c.gfx0(1836);
		 * c.specAccuracy = 2.00; c.specDamage = 1.30; c.hitDelay = 3; c.projectileStage
		 * = 1; c.hitDelay =
		 * getHitDelay(c.getItems().getItemName(c.playerEquipment[c.playerWeapon]).
		 * toLowerCase()); if (c.fightMode == 2) c.attackTimer--; if (c.playerIndex > 0)
		 * fireProjectilePlayer(); else if (c.npcIndex > 0) fireProjectileNpc(); break;
	...
	public boolean checkReqs() {
			...
			CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
				public void execute(CycleEventContainer container) {
					...
					if (c.attackTimer == 4) {
						...
						c.sendMessage(
								"You have sucessfully banned " + PlayerHandler.players[c.playerIndex].playerName + ".");
		...
		if (!Server.playerHandler.players[c.playerIndex].inWild()
				&& !Server.playerHandler.players[c.playerIndex].inPits()
				&& !Server.playerHandler.players[c.playerIndex].inDuelArena()) {
			// c.Snowball(c);
			c.stopMovement();
			c.getCombat().resetPlayerAttack();
			return false;
		...
		if (!Server.playerHandler.players[c.playerIndex].inWild()
				&& !Server.playerHandler.players[c.playerIndex].InDung()
				&& !Server.playerHandler.players[c.playerIndex].inDuelArena()
				&& Server.playerHandler.players[c.playerIndex].safeTimer <= 0
				&& !Server.playerHandler.players[c.playerIndex].inPits()) {
		...
		if (!c.inFunPk()) {
			if (Config.COMBAT_LEVEL_DIFFERENCE) {
				int combatDif1 = c.getCombat().getCombatDifference(c.combatLevel,
						Server.playerHandler.players[c.playerIndex].combatLevel);
	...
	public boolean checkMultiBarrageReqs(int i) {
		...
		if (Config.COMBAT_LEVEL_DIFFERENCE && !c.inFunPk() && !Server.playerHandler.players[i].inFunPk()) {
			int combatDif1 = c.getCombat().getCombatDifference(c.combatLevel,
					Server.playerHandler.players[i].combatLevel);
		...
		if (Config.SINGLE_AND_MULTI_ZONES) {
			if (!Server.playerHandler.players[i].inMulti()) { // single combat zones
				if (Server.playerHandler.players[i].underAttackBy != c.playerId
						&& Server.playerHandler.players[i].underAttackBy != 0) {
					return false;
				}
	...
	public void getPlayerAnimIndex(String weaponName) {
		...
		if (weaponName.contains("longsword") || weaponName.contains("scimitar") || weaponName.contains("silverlight")
		...
		if (weaponName.contains("wand") || weaponName.contains("staff") || weaponName.contains("staff")
	...
	public int getWepAnim(String weaponName) {
		 ...
		 * weaponName.contains("saradomin sword")) { switch(c.fightMode) { case 0:
		 * return 7041; case 2: return 7042; case 1: return 7048; } }
		 */
		if (weaponName.contains("2h sword") || weaponName.contains("godsword")
		 ...
		 * weaponName.contains("korasi's")) { switch(c.fightMode) { case 0: return
		 * 12029; case 1: // New Scimmi models return 12029; case 2: return 12029; case
		 * 3: return 12028; } }
		 */
		if (weaponName.contains("scimitar") || weaponName.contains("longsword") || weaponName.contains("korasi's")
				|| weaponName.contains("rapier") || weaponName.contains("sword")) {
			if (Misc.random(3) == 1) {
				return 10504;
			}
			if (Misc.random(3) == 2) {
		...
		/*
		 * if(weaponName.contains("rapier")) { switch(c.fightMode) { case 0: return 386;
		 * case 1: return 386; case 2: return 386; case 3: return 386; } }
		 */
		if (weaponName.contains("dharok")) {
			switch (c.fightMode) {
			case 0:
	...
	public int getHitDelay(String weaponName) {
		if (c.usingMagic) {
			...
			if (weaponName.contains("knife") || weaponName.contains("dart") || weaponName.contains("javelin")
					|| weaponName.contains("thrownaxe") || c.playerEquipment[c.playerWeapon] == 13879
					|| c.playerEquipment[c.playerWeapon] == 13883) {
				return 3;
			}
	...
	public int calculateMeleeAttack() {
		...
		// c.sendMessage("Attack: " + (attackLevel + (c.playerBonus[bestMeleeAtk()] *
		// 2)));
	...
	/*
	 * public int rangeMaxHit() { int rangeLevel = c.playerLevel[4]; double modifier
	 * = 1.0; double wtf = c.specDamage; int itemUsed = c.usingBow ? c.lastArrowUsed
	 * : c.lastWeaponUsed; if (c.prayerActive[3]) modifier += 0.05; else if
	 * (c.prayerActive[11]) modifier += 0.10; else if (c.prayerActive[19]) modifier
	 * += 0.15; if (c.fullVoidRange()) modifier += 0.20; double c = modifier *
	 * rangeLevel; int rangeStr = getRangeStr(itemUsed); double max =(c + 8) *
	 * (rangeStr + 64) / 640; if (wtf != 1) max *= wtf; if (max < 1) max = 1; return
	 * (int)max; }
	 */
	...
	public void drawback() {
		...
		/*
		 * else if (playerEquipment[playerWeapon] == 13649){ javerlin(105, 1190); } else
		 * if (playerEquipment[playerWeapon] == 13650){ thaxe(105, 1195); }
		 */
				...
				for (int r = 0; r < c.REDUCE_SPELLS.length; r++) { // reducing spells, confuse etc
					if (Server.playerHandler.players[c.playerIndex].REDUCE_SPELLS[r] == c.MAGIC_SPELLS[spell][0]) {
						...
						if ((System.currentTimeMillis()
								- Server.playerHandler.players[c.playerIndex].reduceSpellDelay[c.reduceSpellId]) > Server.playerHandler.players[c.playerIndex].REDUCE_SPELL_TIME[c.reduceSpellId]) {
					...
					if (c.dfsCounter < 2) {
						...
						if (System.currentTimeMillis() - c.dfsDelay > 30000) {
							if (c.playerIndex > 0 && Server.playerHandler.players[c.playerIndex] != null) {
								...
								c.sendMessage("You must wait another <shad=15007744>" + c.dfsCounter
										+ "</shad> seconds before using this again.");
							}
						} else {
	...
	public void handleSeers() {
		/*
		 * 
		 * c.castingMagic = true; if(c.isDonator == 1){ if (System.currentTimeMillis() -
		 * c.dfsDelay > 60000) { if (c.playerIndex > 0 &&
		 ...
		 * 
		 * Server.playerHandler.players[c.playerIndex].hitUpdateRequired2 = true;
		 * Server.playerHandler.players[c.playerIndex].updateRequired = true; c.dfsDelay
	...
	/*
	 * public void handleDfsNPC() { try { if(c.npcIndex > 0) {
	 * if(Server.npcHandler.npcs[c.npcIndex] != null) { c.projectileStage = 2; final
	 * int pX = c.getX(); final int pY = c.getY(); final int nX =
	 * Server.npcHandler.npcs[c.npcIndex].getX(); final int nY =
	 * Server.npcHandler.npcs[c.npcIndex].getY(); final int offX = (pY - nY)* -1;
	 * final int offY = (pX - nX)* -1; if (System.currentTimeMillis() - c.dfsDelay >
	 * 30000) { if (c.npcIndex > 0 && Server.npcHandler.npcs[c.npcIndex] != null) {
	 * final int damage = Misc.random(35) + 5; c.startAnimation(6696); c.gfx0(1165);
	 * Server.npcHandler.npcs[c.npcIndex].hitUpdateRequired2 = true;
	 * Server.npcHandler.npcs[c.npcIndex].updateRequired = true;
	 * Server.npcHandler.npcs[c.npcIndex].hitDiff2 = damage;
	 * Server.npcHandler.npcs[c.npcIndex].HP -= damage;
	 ...
	 * execute(EventContainer b) { c.getPA().createPlayersProjectile(pX, pY, offX,
	 * offY, 50, 50, 1166, 31, 35, - c.npcIndex - 1, 30); b.stop(); } }, 1000);
	 * if(Server.npcHandler.npcs[c.npcIndex].isDead == true) {
	 * c.sendMessage("This NPC is already dead!"); return; } c.dfsDelay =
	 * System.currentTimeMillis(); } else {
	 * c.sendMessage("I should be in combat before using this."); } } else {
	 * c.sendMessage("My shield hasn't finished recharging yet."); } } } } catch
	 * (Exception e) { } }
	 */
	...
	public void Deflect(int damage, int i) {
		if (damage > 0 && Server.playerHandler.players[i].curseActive[7]
				|| Server.playerHandler.players[i].curseActive[8] || Server.playerHandler.players[i].curseActive[9]) {
