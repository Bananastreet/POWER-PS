...
public class Hack3rPouch {
	...
	public static void makePouch(Client c, int packetType, int packetSize) {
		...
		String[][] summoningPouchData = { // This is the 'database' for the XP/ i use this for other things too. //Gabbe
				{ "Spirit wolf pouch", "Gold Charm", "Wolf bones", "7", "1", "Howl scroll", "6829" },
				{ "Dreadfowl pouch", "Gold Charm", "Raw chicken", "8", "4", "Dreadfowl strike scroll", "6825" },
				{ "Spirit spider pouch", "Gold Charm", "Spider carcass", "8", "10", "Egg spawn scroll", "6841" },
				{ "Thorny Snail pouch", "Gold Charm", "Thin snail", "9", "13", "Slime spray scroll", "6806" },
				{ "Granite Crab pouch", "Gold Charm", "Iron ore", "7", "16", "Stony shell scroll", "6796" },
				{ "Mosquito pouch", "Gold Charm", "Proboscis", "1", "17", "Pester scroll", "7331" },
				{ "Desert wyrm pouch", "Green Charm", "Bucket of sand", "45", "18", "Electric lash scroll", "6831" },
				{ "Spirit Scorpion pouch", "Crimson Charm", "Bronze claws", "57", "19", "Venom shot scroll", "6837" },
				{ "Spirit tz-kih pouch", "crimson charm", "Obsidian charm", "64", "22", "Fireball assault scroll", "7361" },
				{ "Albino rat pouch", "Blue Charm", "Raw rat meat", "75", "23", "Cheese feast scroll", "6847" },
				{ "Spirit kalphite pouch", "blue Charm", "potato cactus", "51", "25", "Sandstorm scroll", "6994" },
				{ "Compost mound pouch", "Green charm", "compost", "47", "28", "Generate compost scroll", "6871" },
				{ "Giant chinchompa pouch", "Blue Charm", "Chinchompa", "84", "29", "Explode scroll", "7353" },
				{ "Vampire bat pouch", "Crimson Charm", "Vampire dust", "81", "31", "Vampire touch scroll", "6835" },
				{ "Honey badger pouch", "Crimson Charm", "Honeycomb", "84", "32", "Insane ferocity scroll", "6845" },
				{ "Beaver pouch", "Green Charm", "Willow logs", "72", "33", "Multichop scroll", "6807" },
				{ "Void ravager pouch", "green Charm", "Ravager Charm", "74", "34", "Call to arms scroll", "7370" },
				{ "Void shifter pouch", "blue charm", "Shifter charm", "74", "34", "Call to arms scroll", "7367" },
				{ "void spinner pouch", "blue Charm", "spinner Charm", "74", "34", "Call to arms scroll", "7333" },
				{ "Void Torcher pouch", "blue Charm", "Torcher Charm", "74", "34", "Call to arms scroll", "7351" },
				{ "Bronze minotaur pouch", "Blue Charm", "Bronze bar", "102", "36", "Bronze bull rush scroll", "6853" },
				{ "Bull ant pouch", "gold Charm", "Marigolds", "11", "40", "Unburden scroll", "6867" },
				{ "Macaw pouch", "green Charm", "Clean guam", "78", "41", "Herbcall scroll", "6851" },
				{ "Evil turnip pouch", "crimson Charm", "Carved turnip", "104", "42", "Evil flames scroll", "6833" },
				{ "Evil turnip pouch", "crimson Charm", "Carved turnip", "104", "42", "Evil flames scroll", "6833" },
				{ "Evil turnip pouch", "crimson Charm", "Carved turnip", "104", "42", "Evil flames scroll", "6833" },
				{ "Evil turnip pouch", "crimson Charm", "Carved turnip", "104", "42", "Evil flames scroll", "6833" },
				{ "Evil turnip pouch", "crimson Charm", "Carved turnip", "104", "42", "Evil flames scroll", "6833" },
				...
				{ "Evil turnip pouch", "crimson Charm", "Carved turnip", "104", "42", "Evil flames scroll", "6833" },
				{ "Evil turnip pouch", "crimson Charm", "Carved turnip", "104", "42", "Evil flames scroll", "6833" },
				{ "Iron minotaur pouch", "Blue Charm", "Iron bar", "125", "46", "Iron bull rush scroll", "6855" },
				{ "Pyrelord pouch", "Crimson Charm", "Tinderbox", "111", "46", "Immense heat scroll", "7377" },
				{ "Magpie pouch", "green Charm", "Gold ring", "88", "47", "Thieving fingers scroll", "6824" },

				{ "Bloated leech pouch", "Crimson Charm", "Raw beef", "117", "49", "Blood drain scroll", "6843" },
				{ "Spirit terrorbird pouch", "Gold Charm", "Raw bird meat", "12", "52", "Tireless run scroll", "3596" },
				{ "Abyssal parasite pouch", "green Charm", "Abyssal charm", "106", "54", "Abyssal drain scroll",
						"6818" },
				{ "Spirit jelly pouch", "blue Charm", "Jug of water", "151", "55", "Dissolve scroll", "6922" },
				{ "Steel minotaur pouch", "blue Charm", "steel bar", "141", "56", "Fish rain scroll", "6857" },
				{ "Ibis pouch", "green Charm", "Harpoon", "109", "56", "Steel bull rush scroll", "6991" },
				{ "Spirit Graahk pouch", "blue Charm", "graahk fur", "154", "57", "Ambush scroll", "3588" },
				{ "Spirit Kyatt pouch", "blue Charm", "Kyatt fur", "153", "57", "Rending scroll", "7365" },
				{ "Spirit larupia pouch", "blue Charm", "larupia fur", "155", "57", "Goad scroll", "7337" },
				{ "Karamthulhu overlord pouch", "blue Charm", "Empty fishbowl", "144", "58", "Doomsphere scroll",
						"6809" },
				{ "Smoke devil pouch", "Crimson Charm", "Goat horn dust", "141", "61", "Dust cloud scroll", "6865" },
				{ "Abyssal lurker", "green Charm", "Abyssal charm", "119", "62", "Abyssal stealth scroll", "6820" },
				...
				{ "Mithril minotaur pouch", "Blue Charm", "Mithril bar", "152", "66", "Mithril bull rush scroll",
						"6859" },
				{ "Barker toad pouch", "Gold Charm", "Swamp toad", "11", "66", "Toad bark scroll", "6889" },
				{ "War tortoise pouch", "Gold Charm", "Tortoise shell", "1", "67", "Testudo scroll", "6815" },
				{ "Bunyip pouch", "Green Charm", "Raw shark", "110", "68", "Swallow whole scroll", "6813" },
				{ "Fruit bat pouch", "Green Charm", "Banana", "130", "69", "Fruitfall scroll", "6817" },
				{ "Ravenous Locust pouch", "Crimson Charm", "Pot of Flour", "79", "70", "Famine scroll", "7372" },
				{ "Arctic bear pouch", "Gold Charm", "Polar kebbit fur", "14", "71", "Arctic blast scroll", "6839" },
				{ "Phoenix pouch", "Crimson Charm", "Phoenix Quill", "165", "72", "Phoenix unknown scroll", "1911" },
				...
				{ "Granite lobster pouch", "Crimson Charm", "Granite (500g)", "166", "74", "Crushing claw scroll",
						"6849" },
				{ "Praying mantis pouch", "Crimson Charm", "Flowers", "168", "75", "Mantis strike scroll", "6798" },
				{ "Adamant minotaur pouch", "Blue Charm", "Adamant Bar", "144", "76", "Inferno scroll", "6861" },
				...
				{ "Talon Beast pouch", "Crimson Charm", "Talon Beast charm", "174", "77", "Deadly claw scroll",
						"7347" },
				{ "Giant ent pouch", "Green Charm", "Willow branch", "124", "78", "Acorn missile scroll", "6800" },
				...
				{ "Moss titan pouch", "Blue Charm", "Earth talisman", "202", "79", "Titan's constitution scroll",
						"7357" },
				{ "Hydra pouch", "Green Charm", "Water orb", "128", "80", "Regrowth scroll", "6811" },
				{ "Spirit dagannoth", "Crimson Charm", "Dagannoth hide", "1", "83", "Spike shot scroll", "6804" },
				{ "Lava titan pouch", "Blue Charm", "Obsidian Charm", "219", "83", "Ebon thunder scroll", "7341" },
				{ "Swamp titan pouch", "Blue Charm", "Swamp lizard", "150", "85", "Swamp plague scroll", "7329" },
				{ "Rune minotaur pouch", "Blue Charm", "Rune bar", "1", "86", "Rune bull rush scroll", "6863" },
				{ "Unicorn stallion pouch", "green Charm", "Unicorn Horn", "140", "88", "Healing aura scroll", "3592" },
				{ "Geyser titan pouch", "blue Charm", "Water talisman", "222", "89", "Boil scroll", "7339" },
				{ "Wolpertinger pouch", "crimson Charm", "Raw rabbit", "203", "92", "Magic focus scroll", "3593" },
				{ "Abyssal titan pouch", "green Charm", "Abyssal charm", "113", "93", "Essence shipment scroll",
						"7349" },
				{ "Iron titan pouch", "crimson Charm", "Iron platebody", "198", "95", "Iron within scroll", "7375" },
				{ "Pack yak pouch", "Crimson Charm", "Yak-hide", "211", "96", "Winter storage scroll", "3594" },
		...
		case 91184: // START OF SUMMONING POUCHES // Wolf
			...
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(12158, 1) && c.getItems().playerHasItem(2859, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 7)
						&& c.playerLevel[21] >= 1) {
		...
		case 91192: // Dreadfowl chicken pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(12158, 1) && c.getItems().playerHasItem(2138, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 8)
						&& c.playerLevel[21] >= 4) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 91200: // spirit spider pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(12158, 1) && c.getItems().playerHasItem(6291, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 8)
						&& c.playerLevel[21] >= 10) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 91208: // thorny snail
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(12158, 1) && c.getItems().playerHasItem(3369, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 9)
						&& c.playerLevel[21] >= 13) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 91216: // Granite crab
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(12158, 1) && c.getItems().playerHasItem(440, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 7)
						&& c.playerLevel[21] >= 16) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 91224: // Mosquito
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(12158, 1) && c.getItems().playerHasItem(6319, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 20)
						&& c.playerLevel[21] >= 17) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 91232: // Desert Wyrm
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GRCHARM, 1) && c.getItems().playerHasItem(1783, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 45)
						&& c.playerLevel[21] >= 18) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 91240: // Spirit Scorpion
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(3095, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 57)
						&& c.playerLevel[21] >= 19) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 91248: // Spirit tz-kih pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(12168, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 64)
						&& c.playerLevel[21] >= 22) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					...
					c.sendMessage("To create this pouch you need to have:");
					c.sendMessage(
							"Lvl 22 Summoning & 1 Crimson Charm & 1 Obsidian Charm & 64 Spirit Shards & 1 Pouch.");
					c.hasSentMessage = true;
				}
			}
			break;
		...
		case 92008: // Spirit Kalphite
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(3138, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 51)
						&& c.playerLevel[21] >= 25) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92016: // Compost Mound
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GCHARM, 1) && c.getItems().playerHasItem(6032, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 47)
						&& c.playerLevel[21] >= 28) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92024: // Giant ChinChompa Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(9976, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 84)
						&& c.playerLevel[21] >= 29) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92032: // Vampire Bat Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(3325, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 81)
						&& c.playerLevel[21] >= 31) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92040: // Honey Badger Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(12156, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 84)
						&& c.playerLevel[21] >= 32) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92048: // Beaver Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GCHARM, 1) && c.getItems().playerHasItem(1519, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 72)
						&& c.playerLevel[21] >= 33) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					c.getPA().addSkillXP(14000, 21);
		...
		case 92056: // Void ravager
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GCHARM, 1) && c.getItems().playerHasItem(12164, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 74)
						&& c.playerLevel[21] >= 34) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					c.getPA().addSkillXP(14200, 21);
		...
		case 92064: // Void Spinner pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(12166, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 74)
						&& c.playerLevel[21] >= 34) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92072: // Void torcher pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(12167, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 74)
						&& c.playerLevel[21] >= 34) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92080: // Void Shifter pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(12165, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 74)
						&& c.playerLevel[21] >= 34) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92088: // Bronze minotaur
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(2349, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 102)
						&& c.playerLevel[21] >= 36) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92096: // Bull ant
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GCHARM, 1) && c.getItems().playerHasItem(6010, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 11)
						&& c.playerLevel[21] >= 40) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92104: // Macaw
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GRCHARM, 1) && c.getItems().playerHasItem(249, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 78)
						&& c.playerLevel[21] >= 41) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92112: // Macaw
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(12153, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 104)
						&& c.playerLevel[21] >= 42) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					...
					c.sendMessage("To create this pouch you need to have:");
					c.sendMessage(
							"Lvl 42 Summoning & 1 Crimson Charm & 1 Carved Evil Turnip & 104 Spirit Shards & 1 Pouch.");
		...
		case 92176: // Iron minotaur
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(2351, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 125)
						&& c.playerLevel[21] >= 46) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92184: // pyrelord
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(590, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 111)
						&& c.playerLevel[21] >= 46) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92192: // Magpie
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GCHARM, 1) && c.getItems().playerHasItem(1635, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 88)
						&& c.playerLevel[21] >= 47) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92200: // Bloated Leech Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(2132, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 117)
						&& c.playerLevel[21] >= 49) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92208: // Spirit terrorbird
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GCHARM, 1) && c.getItems().playerHasItem(9978, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 12)
						&& c.playerLevel[21] >= 52) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92216: // Abbysal parasite
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GRCHARM, 1) && c.getItems().playerHasItem(12161, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 106)
						&& c.playerLevel[21] >= 54) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					c.getPA().addSkillXP(16000, 21);
		...
		case 92224: // Spirit Jelly
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(1937, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 151)
						&& c.playerLevel[21] >= 55) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92232: // Steel minotaur pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(2353, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 141)
						&& c.playerLevel[21] >= 56) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 92240: // Ibis pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GRCHARM, 1) && c.getItems().playerHasItem(311, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 109)
						&& c.playerLevel[21] >= 56) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					c.getPA().addSkillXP(17500, 21);
		...
		case 92248: // Spirit Graahk pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(10099, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 154)
						&& c.playerLevel[21] >= 57) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93000: // Spirit Kyatt pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(10103, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 153)
						&& c.playerLevel[21] >= 57) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					c.getPA().addSkillXP(19400, 21);
		...
		case 93008: // Spirit larupia pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(10095, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 155)
						&& c.playerLevel[21] >= 57) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					c.getPA().addSkillXP(19400, 21);
		...
		case 93016: // Spirit Karamthulhu overlord pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(6723, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 144)
						&& c.playerLevel[21] >= 58) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93024: // Smoke devil pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(9736, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 141)
						&& c.playerLevel[21] >= 61) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					...
					c.sendMessage("To create this pouch you need to have:");
					c.sendMessage(
							"Lvl 61 Summoning & 1 Crimson Charm & 1 Goat horn Dust & 141 Spirit Shards & 1 Pouch.");
		...
		case 93032: // abyssal lurker
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GCHARM, 1) && c.getItems().playerHasItem(12161, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 119)
						&& c.playerLevel[21] >= 62) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93040: // Spirit Cobra
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(7801, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 116)
						&& c.playerLevel[21] >= 63) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93048: // Stranger Plant pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(8431, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 128)
						&& c.playerLevel[21] >= 64) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					...
					c.sendMessage("To create this pouch you need to have:");
					c.sendMessage(
							"Lvl 64 Summoning & 1 Crimson Charm & 1 Bagged Plant 1 & 128 Spirit Shards & 1 Pouch.");
		...
		case 93056: // Mithril Minotaur
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(2359, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 152)
						&& c.playerLevel[21] >= 66) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93064: // Barker toad pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GCHARM, 1) && c.getItems().playerHasItem(2150, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 11)
						&& c.playerLevel[21] >= 66) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93072: // Spirit War tortoise
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GCHARM, 1) && c.getItems().playerHasItem(7939, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 131)
						&& c.playerLevel[21] >= 67) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93080: // Bunyip
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GRCHARM, 1) && c.getItems().playerHasItem(383, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 110)
						&& c.playerLevel[21] >= 68) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93088: // Fruit Bat
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GRCHARM, 1) && c.getItems().playerHasItem(1963, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 130)
						&& c.playerLevel[21] >= 69) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93096: // Ravenous Locust
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(1933, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 79)
						&& c.playerLevel[21] >= 70) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93104: // Arctic bear
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GCHARM, 1) && c.getItems().playerHasItem(10117, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 80)
						&& c.playerLevel[21] >= 71) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					c.getPA().addSkillXP(19900, 21);
		...
		case 93112: // Phoenix
			 ...
			 * c.getItems().playerHasItem(14616, 1) && c.getItems().playerHasItem(POUCH, 1)
			 * && c.getItems().playerHasItem(SHARD, 165) && c.playerLevel[21] >= 72) {
			 * //c.getPA().closeAllWindows(); c.gfx0(2128);
			 * c.getPA().addSkillXP(summoningPouchData[i][4]) * 900, 21);
			 * //c.sendMessage("You created ; Phoenix Pouch");
			 * c.getItems().deleteItem(14616, 1); c.getItems().deleteItem(POUCH, 1);
			 * c.getItems().deleteItem(SHARD, 165); c.getItems().deleteItem(CCHARM, 1);
			 * c.getItems().addItem(14623, 1); } else { if (c.hasSentMessage == true) {
			 * return; } c.sendMessage("To create this pouch you need to have:"); c.
			 * sendMessage("Lvl 72 Summoning & 1 Crimson Charm & 1 Phoenix Quill & 165 Spirit Shards & 1 Pouch."
			 * );
			 * 
			 * c.hasSentMessage = true; } }
			 */
		...
		case 93120: // Obsidian Golem Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(12168, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 195)
						&& c.playerLevel[21] >= 73) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93128: // Granite Lobster Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(6979, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 166)
						&& c.playerLevel[21] >= 74) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					...
					c.sendMessage("To create this pouch you need to have:");
					c.sendMessage(
							"Lvl 74 Summoning & 1 Crimson Charm & 1 Granite(500G) & 166 Spirit Shards & 1 Pouch.");
					c.hasSentMessage = true;
				}
			}
			break;
		...
		case 93136: // Praying mantis pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(2460, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 168)
						&& c.playerLevel[21] >= 75) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93144: // Adamant Minotaur pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(2361, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 144)
						&& c.playerLevel[21] >= 76) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93152: // Forge Regent pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GRCHARM, 1) && c.getItems().playerHasItem(10020, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 141)
						&& c.playerLevel[21] >= 76) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93160: // Talon Beast pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(12162, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 174)
						&& c.playerLevel[21] >= 77) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					...
					c.sendMessage("To create this pouch you need to have:");
					c.sendMessage(
							"Lvl 77 Summoning & 1 Crimson Charm & 1 Talon Beast charm & 174 Spirit Shards & 1 Pouch.");
					c.hasSentMessage = true;
				}
			}
			break;
		...
		case 93168: // Giant ent Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GRCHARM, 1) && c.getItems().playerHasItem(5933, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 124)
						&& c.playerLevel[21] >= 78) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93176: // Fire Titan Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(1442, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 198)
						&& c.playerLevel[21] >= 79) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93184: // Moss Titan Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(1440, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 198)
						&& c.playerLevel[21] >= 79) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93192: // Ice Titan Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(1444, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 198)
						&& c.playerLevel[21] >= 79) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93200: // Hyda pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GRCHARM, 1) && c.getItems().playerHasItem(571, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 128)
						&& c.playerLevel[21] >= 80) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93208: // spirit dagannoth
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(6155, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 122)
						&& c.playerLevel[21] >= 83) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					c.getPA().addSkillXP(22900, 21);
					...
					c.sendMessage("To create this pouch you need to have:");
					c.sendMessage(
							"Lvl 83 Summoning & 1 Crimson Charm & 1 Dagannoth hide & 122 Spirit Shards & 1 Pouch.");
					c.hasSentMessage = true;
				}
			}
			break;
		...
		case 93216: // Lava Titan pouch
			...
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(12168, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 219)
						&& c.playerLevel[21] >= 83) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93224: // Swamp Titan pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(10149, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 150)
						&& c.playerLevel[21] >= 85) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93232: // Rune minotaur pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(2363, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 111)
						&& c.playerLevel[21] >= 86) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 93240: // Unicorn stallion pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GRCHARM, 1) && c.getItems().playerHasItem(237, 1)
						&& c.getItems().playerHasItem(POUCH, 1) && c.getItems().playerHasItem(SHARD, 140)
						&& c.playerLevel[21] >= 88) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					c.getPA().addSkillXP(22900, 21);
		...
		case 93248: // Geyser Titan Pouch
			...
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(1444, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 222)
						&& c.playerLevel[21] >= 89) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 94000: // Wolpertinger Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(3226, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 203)
						&& c.playerLevel[21] >= 92) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 94008: // abyssal Titan Pouch
			...
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(GRCHARM, 1) && c.getItems().playerHasItem(12161, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 113)
						&& c.playerLevel[21] >= 93) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 94016: // Iron Titan Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(1115, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 198)
						&& c.playerLevel[21] >= 95) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
					...
					c.sendMessage("To create this pouch you need to have:");
					c.sendMessage(
							"Lvl 95 Summoning & 1 Crimson Charm & 1 Iron PlateBody & 198 Spirit Shards & 1 Pouch.");
					c.hasSentMessage = true;
				}
			}
			break;
		...
		case 94024: // Pack Yak Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(CCHARM, 1) && c.getItems().playerHasItem(10818, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 211)
						&& c.playerLevel[21] >= 96) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
		...
		case 94032: // Steel Titan Pouch
			c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {
				if (c.getItems().playerHasItem(BCHARM, 1) && c.getItems().playerHasItem(1119, 1)
						&& c.getItems().playerHasItem(12155, 1) && c.getItems().playerHasItem(18016, 178)
						&& c.playerLevel[21] >= 99) {
					// c.getPA().closeAllWindows();
					c.gfx0(2128);
