...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 397:
				...
				case 129:
				sendNpcChat4(
					"Hello! I am the master of prestige!",
					"People talk to me to reset their 110",
					"combat skills! And they even get rewarded",
					"based on how many times they did it!",
					3919, "Miss Prestige");
				c.nextChat = 130;
			break;
			case 130:
				sendOption2(
					"I wish to access the Prestige Shop",
					"I wish to prestige..");
				c.nextChat = 0;
...
sendNpcChat3("Welcome my friend!", "Here you can train Woodcutting", "Buy your axe from me and get started!", c.talkingNpc, "Woodcutter");
	...
	break;
	case 25000:
		sendNpcChat4("Warning!","Bank all items including euipped before entering.","You will lose them otherwise.","Make sure to have coins in your money pouch.", c.talkingNpc, "Dungeoneering");
		c.nextChat = 25001;
	break;
	case 25001:
...
break;
	...
	case 76:
		...
		break;
		case 1002:
		sendNpcChat4("Hello, My name is Sigli", "I am a master of Hunter, h20 has asked me", "To direct players to hunter.", 
		...
		break;case 1009:
		sendNpcChat4("Hello, I sell Perfect sword`s, A Best", "Weapon in Power-Ps. It costs:", "Cb`axe,Hellsword,Omg Whip,Cl`sword &", 
			"A Godsun blade. Would you like to buy one?", c.talkingNpc, "Weapon God");
			c.nextChat = 1010;
		break;
		case 1010:
		sendOption2("Yes, that sounds great.", "Not right now.");
		...
		break;
		case 1011:
		sendNpcChat4("Hello, I sell Faithful Shields, A Powerful", "Shield in Power-Ps. It costs:", "Just 35 2b Tickets", 
			"Would you like to buy one?", c.talkingNpc, "Ana");
			c.nextChat = 1012;
		break;
		case 1012:
		sendOption2("Yes, that sounds great.", "Not right now.");
		...
		break;
		case 1013:
			sendNpcChat4("Hello, I sell 'Attacker Level 1', A Decent Cosmetic", "in Power-Ps. It costs:", "1 Pummeler Point", 
			"Would you like to buy one?", c.talkingNpc, "Student");
			c.nextChat = 1014;
		break;
		case 1014:
			sendOption2("Yes, that sounds great.", "Not right now.");
		...
		break;
		case 1015:
			sendNpcChat4("Hello, I sell 'Attacker Level 2', A Decent Cosmetic", "in Power-Ps. It costs:", "9 Pummeler Points & an Attacker level 1", 
			"Would you like to buy one?", c.talkingNpc, "Examiner");
			c.nextChat = 1016;
		break;
		case 1016:
			sendOption2("Yes, that sounds great.", "Not right now.");
		...
		break;
		case 1017:
			sendNpcChat4("Hello, I sell 'Attacker Level 3', A Decent Cosmetic", "in Power-Ps. It costs:", "15 Pummeler Points & an Attacker level 2", 
			"Would you like to buy one?", c.talkingNpc, "Expert");
			c.nextChat = 1018;
		break;
		case 1018:
			sendOption2("Yes, that sounds great.", "Not right now.");
		...
		break;
		case 1019:
			sendNpcChat4("Hello, I sell 'Attacker Level 4', A Decent Cosmetic", "in Power-Ps. It costs:", "25 Pummeler Points & an Attacker level 3", 
			"Would you like to buy one?", c.talkingNpc, "Panning Guide");
			c.nextChat = 1020;
		break;
		case 1020:
			sendOption2("Yes, that sounds great.", "Not right now.");
		...
		break;
		case 1021:
			sendNpcChat4("Hello, I sell 'Attacker Level 5', A Decent Cosmetic", "in Power-Ps. It costs:", "50 Pummeler Points & an Attacker level 4", 
			"Would you like to buy one?", c.talkingNpc, "Gnomeballer");
			c.nextChat = 1022;
		break;
		case 1022:
			sendOption2("Yes, that sounds great.", "Not right now.");
		...
		break;
		case 1023:
			sendNpcChat4("Hello, I sell A Custom Rank, You will", "Gain access to ::pnpc & extra features.", "It costs 500k Power-Ps Points & 100k Custom Points", 
			"Are you interested?", c.talkingNpc, "Gnomeballer");
			c.nextChat = 1024;
		break;
		case 1024:
			sendOption2("Yes, that sounds great.", "Not right now.");
