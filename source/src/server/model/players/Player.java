...
public abstract class Player {
	...
	public long recordedLogin = 0;// the current time in ms set when you login. used to calculate time logged in
									// when you logout
	...
	public boolean playerFletch, playerIsFletching, fletchLevelReq, playerIsMining, playerIsFiremaking, playerIsFishing,
	...
	public int VesBeastKilled = 0;
	public int ProtectorKilled = 0;
	public int WreckerKilled = 0;
	public int GiantMoleKilled = 0;
	public int KalQueenKilled = 0;
	public int ForgottenWarriorKilled = 0;
	public int MadMummyKilled = 0;
	public int PredatorTorvaKilled = 0;
	public int FlameTorvaKilled = 0;
	public int BlueTorvaKilled = 0;
	public int Torva24KKilled = 0;
	public int BurstTorvaKilled = 0;
	public int CyrexTorvaKilled = 0;
	...
	public int recoveryDelay = 3, attemptsRemaining = 3, lastPinSettings = -1, setPinDate = -1, changePinDate = -1,
			deletePinDate = -1, firstPin = 0, secondPin = 0, thirdPin = 0, fourthPin = 0, bankPin1 = 0, bankPin2 = 0,
			bankPin3 = 0, bankPin4 = 0;

	public boolean banking, enterdBankpin, firstPinEnter, secondPinEnter, thirdPinEnter, hasBankPin, fourthPinEnter;
	...
	public boolean initialized = false, disconnected = false, ruleAgreeButton = false, RebuildNPCList = false,
			isActive = false, isKicked = false, sit = false, Jail = false, isSkulled = false, friendUpdate = false,
			newPlayer = false, hasMultiSign = false, inAclan = false, saveCharacter = false, mouseButton = false,
			splitChat = false, chatEffects = true, acceptAid = false, nextDialogue = false, autocasting = false,
			viewingOrb = false, usedSpecial = false, mageFollow = false, dbowSpec = false, craftingLeather = false,
			properLogout = false, secDbow = false, maxNextHit = false, ssSpec = false, vengOn = false,
			addStarter = false, accountFlagged = false, readRules = false, msbSpec = false, newCmb = false,
			isBanking = false;

	public int KC, DC, safeTimer = 0, degradeTime, mbPoints, customPoints, PokeMini = 0, PkminiPoints, pummelerPoints,
			christmaspoints, recoil = 0, kingQuest = 0, rMQ = 0, bMQ = 0, ag1, puremaster, ag2, ag3, ag4, ag5, ag6,
			agilitypoints, headIconHints, dbowDelay = 0, pure, saveDelay, altarPrayed = 0, playerKilled, pkPoints,
			ImpLuck, wcLevelReq, totalPlayerDamageDealt, killedBy, lastChatId = 1, vestaDelay = 0, privateChat,
			friendSlot = 0, SolProtect = 0, dialogueId, gloryValue, fishingLevelReq, processPackets = 0, randomCoffin,
			newLocation, CSLS = 0, lastNpcAttacked = 0, specEffect, specBarId, processTimer, attackLevelReq,
			PrayLevelReq, fletchingLevelReq, Magic2LevelReq, strengthLevelReq, SummonLevelReq, HunterLevelReq,
			Dung2LevelReq, Con2LevelReq, CookLevelReq, WCLevelReq, StrLevelReq, RangedLevelReq, FletchLevelReq,
			FishLevelReq, Fm2LevelReq, SmithLevelReq, CraftLevelReq, MineLevelReq, HerbLevelReq, AgilLevelReq,
			ThievLevelReq, SlayLevelReq, FarmLevelReq, RCLevelReq, dungLevelReq, slayerLevelReq, Donatorreq,
			defenceLevelReq, dclaw1, dclaw2, dclaw3, dclaw4, rangeLevelReq, magicLevelReq, followId, Wheel, skullTimer,
			votingPoints, nextChat = 0, talkingNpc = -1, dialogueAction = 0, autocastId, followDistance, followId2,
			barrageCount = 0, delayedDamage = 0, delayedDamage2 = 0, pcPoints, npcKills, superPoints, isDonator,
			issDonator, WildTimer = 0, magePoints = 0, Killed = 0, Death = 0, Dicer = 0, desertTreasure = 0,
			lastArrowUsed = -1, clanId = -1, autoRet = 0, pcDamage = 0, xInterfaceId = 0, xRemoveId = 0,
			xRemoveSlot = 0, tzhaarToKill = 0, RFDToKill = 0, tzhaarKilled = 0, RFDKilled = 0, waveId, frozenBy = 0,
			poisonDamage = 0, teleAction = 0, prayerAction = 0, bonusAttack = 0, newCombat = 0;
	...
	public long lastPlayerMove, lastPoison, lastoverload, lastPoisonSip, poisonImmune, lastSpear, lastProtItem,
			dfsDelay, lastVeng, lastYell, teleGrabDelay, protMageDelay, protMeleeDelay, protRangeDelay, lastAction,
			lastThieve, lastLockPick, alchDelay, specDelay = System.currentTimeMillis(), duelDelay, teleBlockDelay,
			godSpellDelay, singleCombatDelay, singleCombatDelay2, reduceStat, restoreStatsDelay, logoutDelay, buryDelay,
			foodSpawn, foodDelay, emptyDelay, diceDelay, potDelay, lastspin, lastempty;
	...
	public final int[] BOWS = { 18357, 15241, 9185, 839, 845, 847, 851, 855, 859, 841, 843, 849, 853, 857, 861, 4212,
			4214, 4215, 11235, 4216, 4217, 4218, 4219, 4220, 4221, 4222, 4223, 6724, 4734, 4934, 4935, 4936, 4937 };

	public int BlackMarks = 0;

	public final int[] ARROWS = { 15243, 882, 884, 886, 888, 890, 892, 4740, 11212, 9140, 9141, 4142, 9143, 9144, 9240,
			9241, 9242, 9243, 9244, 9245 };

	public final int[] NO_ARROW_DROP = { 15243, 4212, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221, 4222, 4223, 4734,
			4934, 4935, 4936, 4937 };

	public static final int[] Bolts = { 877, 4740, 9139, 9140, 9141, 9142, 9143, 9144, 9145, 9236, 9237, 9238, 9239,
	...
	public final int[] OTHER_RANGE_WEAPONS = { 863, 864, 865, 866, 867, 868, 869, 806, 807, 808, 809, 810, 811, 825,
			826, 827, 828, 829, 830, 800, 801, 802, 803, 804, 805, 6522, 13879, 15016 };

	public final int[][] MAGIC_SPELLS = { { 1152, 1, 711, 90, 91, 92, 2, 5, 556, 1, 558, 1, 0, 0, 0, 0 }, // wind strike
	...
	public boolean torva() {
		if (playerEquipment[playerHat] == 13362 && playerEquipment[playerLegs] == 13360
	...
	public boolean fullVerac() {
		return playerEquipment[playerHat] == 4753 && playerEquipment[playerLegs] == 4759
				&& playerEquipment[playerChest] == 4757 && playerEquipment[playerWeapon] == 4755;
	}

	public boolean fullDharoks() {
		return playerEquipment[playerHat] == 4716 && playerEquipment[playerLegs] == 4722
				&& playerEquipment[playerChest] == 4720 && playerEquipment[playerWeapon] == 4718;
	}
	...
	public boolean fullTorva() {
		return playerEquipment[playerHat] == 20135 && playerEquipment[playerLegs] == 20143
				&& playerEquipment[playerChest] == 20139;
	}

	public boolean fullPernix() {
		return playerEquipment[playerHat] == 20147 && playerEquipment[playerLegs] == 20155
				&& playerEquipment[playerChest] == 20151;
	}

	public boolean fullVirtus() {
		return playerEquipment[playerHat] == 20159 && playerEquipment[playerLegs] == 20167
	...
	public boolean hasFullPrimal() {
		return playerEquipment[playerHat] == 20159 && playerEquipment[playerLegs] == 20167
				&& playerEquipment[playerChest] == 20163
				|| playerEquipment[playerHat] == 20147 && playerEquipment[playerLegs] == 20155
						&& playerEquipment[playerChest] == 20151
				|| playerEquipment[playerHat] == 20135 && playerEquipment[playerLegs] == 20143
						&& playerEquipment[playerChest] == 20139;
	}

	public boolean fullVoidEliteRange() {
		return playerEquipment[playerHat] == 11664 && playerEquipment[playerLegs] == 19786
				&& playerEquipment[playerChest] == 19785 && playerEquipment[playerHands] == 8842;
	}

	public boolean fullVoidEliteMage() {
		return playerEquipment[playerHat] == 11663 && playerEquipment[playerLegs] == 19786
				&& playerEquipment[playerChest] == 19785 && playerEquipment[playerHands] == 8842;
	}

	public boolean fullVoidEliteMelee() {
		return playerEquipment[playerHat] == 11665 && playerEquipment[playerLegs] == 19786
				&& playerEquipment[playerChest] == 19785 && playerEquipment[playerHands] == 8842;
	}
	...
	public int specMaxHitIncrease, freezeDelay, freezeTimer = -6, killerId, playerIndex, oldPlayerIndex, lastWeaponUsed,
			...
			npcClickIndex, npcType, npcID, castingSpellId, oldSpellId, spellId, hitDelay;
	...
	public boolean inFunPk() {
		if (absX > 2582 && absX < 2602 && absY > 3152 && absY < 3171
				|| absX > 3195 && absX < 3234 && absY > 3451 && absY < 3499
	...
	public boolean pkSafe() {
		return (absX >= 3187 && absX <= 3194 && absY >= 3467 && absY <= 3474);
	}
	...
	public boolean hasGrapple() {
		Client c = (Client) PlayerHandler.players[this.playerId];
		if (c.playerEquipment[Player.playerArrows] == 9419) {
			return true;
		}
		return false;
	}
	...
	public boolean inMulti() {
		...
		if ((absX >= 3136 && absX <= 3327 && absY >= 3519 && absY <= 3607)
				...
				|| (absX >= 3046 && absX <= 3064 && absY >= 5187 && absY <= 5212)
				|| (absX >= 2688 && absX <= 2815 && absY >= 9601 && absY <= 9663)
				|| (absX >= 2688 && absX <= 2815 && absY >= 9601 && absY <= 9663)
				|| (absX >= 3195 && absX <= 3234 && absY >= 3451 && absY <= 3499)
				|| (absX >= 2809 && absX <= 2795 && absY >= 4725 && absY <= 4713)
	...
	public void getNextPlayerMovement() {
		...
		if (teleportToX != -1 && teleportToY != -1) {
			...
			if (mapRegionDidChange/*
									 * && VirtualWorld.I(heightLevel, currentX, currentY, currentX + deltaX,
									 * currentY + deltaY, 0)
									 */) {
				currentX += deltaX;
				currentY += deltaY;
	...
	protected void appendPlayerAppearance(Stream str) {
		...
		if (ran > attstr) {
			...
			combatLevel = (int) (((getLevelForXP(playerXP[1])) * 0.25) + ((getLevelForXP(playerXP[3])) * 0.25)
					...
					+ ((getLevelForXP(playerXP[2])) * 0.325) + ((getLevelForXP(playerXP[21])) * 0.121212));
		}
	...
	public boolean wearing2h() {
		Client c = (Client) this;
		c.getItems();
		String s = ItemAssistant.getItemName(c.playerEquipment[Player.playerWeapon]);
		if (s.contains("2h"))
			return true;
	 ...
	 **/
	/*
	 * public boolean UseDefender() { switch(playerEquipment[playerWeapon]) { case
	 * 8844: case 8845: case 8846: case 8847: case 8848: case 8849: case 8850:
	 * break; } return true; }
	 */
	public void startAnimation(int animId) {
		/*
		 * if (wearing2h() && isMoving && animId == 829) return; if (UseDefender() &&
		 * isMoving && animId == 4177) return;
		 */
