...
public class NPC extends Entity {
	 ...
	 */
	public int attackType, projectileId, endGfx, spawnedBy, hitDelayTimer, HP, MaxHP, hitDiff, animNumber, actionTimer,
			enemyX, enemyY;
	...
	public int getNextWalkingDirection() {
		...
		/*
		 * if (dir == -1 || !WalkingHandler.getSingleton().traversable(absX + moveX,
		 * absY + moveY, dir)) return -1;
		 */
		dir >>= 1;
		absX += moveX;
		absY += moveY;
	...
	public boolean inMulti() {
		...
		if ((absX >= 3136 && absX <= 3327 && absY >= 3519 && absY <= 3607)
				...
				|| (absX >= 2797 && absX <= 2808 && absY >= 4712 && absY <= 4725)
				|| (absX >= 2806 && absX <= 2790 && absY >= 4709 && absY <= 4732)
