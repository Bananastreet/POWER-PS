...
public class Item {
	...
	public static boolean playerCape(int itemId) {
		String[] data = {
			"cloak", "cape", "Cape", "attractor", "Attractor", "Ava's", "wings", "Wings"
		};
	...
	public static boolean playerBoots(int itemId) {
		String[] data = {
			"Shoes", "shoes", "boots", "Boots", "Flippers", "flippers", "Icy Boots", "Demonic Boots",
		};
		String item = getItemName(itemId);
		if (item == null) {
			return false;
	...
	public static boolean playerGloves(int itemId) {
		String[] data = {
			"Gloves", "gloves", "glove", "Glove", "Vamb", "vamb", "gauntlets", "Gauntlets", "bracers", "Bracers", "Vambraces", "vambraces", "Demonic Gloves",
		};
		String item = getItemName(itemId);
		if (item == null) {
			return false;
	...
	public static boolean playerAmulet(int itemId) {
		String[] data = {
			"amulet", "Amulet", "scarf", "Necklace", "necklace", "Pendant", "pendant", "Symbol", "symbol", "stole", "Stole", "Scarf"
		};
		String item = getItemName(itemId);
		if (item == null) {
			return false;
	...
	public static boolean playerLegs(int itemId) {
		String[] data = {
			...
			"shorts", "Skirt", "skirt", "cuisse", "Trousers", "Pantaloons", "Demonic Platelegs",
		};
		String item = getItemName(itemId);
		if (item == null) {
			return false;
	...
	private static String[] fullbody = {
		...
		"platebody (t)","platebody (g)","chestplate","poncho", "Asgardian Platebody",
		"torso", "hauberk", "Dragon chainbody", "blouse", "jacket", "Blue Torva Platebody", "24k Torva Platebody", "Cyrex Torva Platebody", "Predator Torva Platebody", "Burst Torva Platebody", "Hellacious Platebody",
		"Flame Torva Platebody", "Ornamental Platebody", "Superior tetsu body", "Fire Torva Platebody", "Aiyana Platebody", "Demonic Plate",
	};

	private static String[] fullhat = {
		"med helm", "coif", "Dharok's helm", "Slayer helmet", "hood", "Initiate helm",
		"Coif","Helm of neitiznot","Armadyl helmet","Berserker helm", "Aiyana helm",
		"Archer helm", "Farseer helm", "Warrior helm", "Void", "Lumberjack hat", "Reindeer hat", "Asgardian Blindfold",
		"Larupia hat", "mask", "Kyatt hat", "Bomber cap", "Dwarven helmet", "Santa Hat", "Blue Torva Fullhelm", "24k Torva Fullhelm", "Cyrex Torva Fullhelm", "Predator Torva Full Helm", "Burst Torva Full Helm",
		"Flame Torva Fullhelm", "Max hood", "NM helmet", "Ornamental Full Helmet", "Superior death lotus hood", "Superior tetsu helm", "Fire Torva Full Helm"
	};

	private static String[] fullmask = {
		"full helm", "Afro", "afro", "mask", "visor", "Verac's helm", "Guthan's helm", "Karil's coif", "mask", "Torag's helm", "sallet", "Saradomin helm", "Lunar helm", "Hellacious Full Helmet", "Brown Torva full helm", "Demonic Fullhelm",
	};
...
itemStackable[counter] = false;
itemStackable[5023] = true; //morrigan throwing axe
itemStackable[5022] = true; //morrigan throwing axe
itemStackable[5021] = true; //morrigan throwing axe
...
itemStackable[6199] = true;
itemStackable[6183] = true;
itemStackable[744] = true;
itemStackable[745] = true;
