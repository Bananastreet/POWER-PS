...
public class UseItem {
	...
	public static void ItemonObject(Client c, int objectID, int objectX, int objectY, int itemId) {
		...
		case 13191:
			...
			break;
		/*
		 * case 409: if (c.getPrayer().isBone(itemId) && c.usingAltar==false) {
		 * c.usingAltar=true; c.altarItemId=itemId; c.getOutStream().createFrame(27); }
		 * break;
		 */
		case 409:
	...
	public static void ItemonItem(Client c, int itemUsed, int useWith) {
		...
		if (itemUsed == 1767 && useWith == 13362) { // PACK YAK SCROLL MAKING
			c.getItems().deleteItem(1767, 1);
			c.getItems().deleteItem(13362, 1);
			c.getItems().addItem(20252, 1);
			c.sendMessage("You make a blue torva helm.");
			return;
		}
		if (itemUsed == 1767 && useWith == 13358) { // PACK YAK SCROLL MAKING
			c.getItems().deleteItem(1767, 1);
			c.getItems().deleteItem(13358, 1);
			c.getItems().addItem(20253, 1);
			c.sendMessage("You make a blue torva Body.");
			return;
		}
		if (itemUsed == 1767 && useWith == 13360) { // PACK YAK SCROLL MAKING
			c.getItems().deleteItem(1767, 1);
			c.getItems().deleteItem(13360, 1);
			c.getItems().addItem(20251, 1);
			c.sendMessage("You make a blue torva Legs.");
			return;
		}
		...
		if (itemUsed == 17413 && useWith == 4151) { // Aqua whip
			...
			c.sendMessage("You drink your vial.");
			c.gfx0(1316);
			return;
		}

		if (itemUsed == 946 && useWith == 771 || itemUsed == 771 && useWith == 946) {
			if (c.playerLevel[9] >= 100) {
				c.startAnimation(899);
				c.sendMessage("You Make a Dramen Staff.");
				c.getItems().deleteItem(771, 1);
				c.getItems().addItem(772, 1);
				c.getPA().addSkillXP(50000, c.playerFletching);
			} else {
				c.sendMessage("You need 100 Fletching to do this.");
				return;
			}
		}

		if (itemUsed == 946 && useWith == 7998 || itemUsed == 7998 && useWith == 946) {
			if (c.playerLevel[9] >= 110) {
				c.startAnimation(899);
				c.sendMessage("You Make a Palm Bow (u).");
				c.getItems().deleteItem(7998, 1);
				c.getItems().addItem(8000, 1);
				c.getPA().addSkillXP(80000, c.playerFletching);
			} else {
				c.sendMessage("You need 110 Fletching to do this.");
				return;
			}
		}
		if (itemUsed == 946 && useWith == 2862 || itemUsed == 2862 && useWith == 946) {
			if (c.playerLevel[9] >= 115) {
				c.startAnimation(899);
				c.sendMessage("You Make an Achey Bow (u).");
				c.getItems().deleteItem(2862, 1);
				c.getItems().addItem(8001, 1);
				c.getPA().addSkillXP(120000, c.playerFletching);
			} else {
				c.sendMessage("You need 115 Fletching to do this.");
				return;
			}
		}
		if (itemUsed == 946 && useWith == 7999 || itemUsed == 7999 && useWith == 946) {
			if (c.playerLevel[9] >= 125) {
				c.startAnimation(899);
				c.sendMessage("You Make a Banana.");
				c.getItems().deleteItem(7999, 1);
				c.getItems().addItem(1963, 1);
				c.getPA().addSkillXP(150000, c.playerFletching);
			} else {
				c.sendMessage("You need 125 Fletching to do this.");
				return;
			}
		}
		if (itemUsed == 590 && useWith == 771 || itemUsed == 771 && useWith == 590) {
			if (c.playerLevel[11] >= 100) {
				c.startAnimation(733);
				c.sendMessage("You light the logs.");
				c.getItems().deleteItem(771, 1);
				c.getPA().addSkillXP(50000, c.playerFiremaking);
			} else {
				c.sendMessage("You need 100 Firemaking to do this.");
				return;
			}
		}
		if (itemUsed == 590 && useWith == 7998 || itemUsed == 7998 && useWith == 590) {
			if (c.playerLevel[11] >= 110) {
				c.startAnimation(733);
				c.sendMessage("You light the logs.");
				c.getItems().deleteItem(7998, 1);
				c.getPA().addSkillXP(80000, c.playerFiremaking);
			} else {
				c.sendMessage("You need 110 Firemaking to do this.");
				return;
			}
		}
		if (itemUsed == 590 && useWith == 2862 || itemUsed == 2862 && useWith == 590) {
			if (c.playerLevel[11] >= 115) {
				c.startAnimation(733);
				c.sendMessage("You light the logs.");
				c.getItems().deleteItem(2862, 1);
				c.getPA().addSkillXP(120000, c.playerFiremaking);
			} else {
				c.sendMessage("You need 115 Firemaking to do this.");
				return;
			}
		}
		if (itemUsed == 590 && useWith == 7999 || itemUsed == 7999 && useWith == 590) {
			if (c.playerLevel[11] >= 125) {
				c.startAnimation(733);
				c.sendMessage("You light the logs.");
				c.getItems().deleteItem(7999, 1);
				c.getPA().addSkillXP(150000, c.playerFiremaking);
			} else {
				c.sendMessage("You need 125 Firemaking to do this.");
				return;
			}
		}
		...
		/**
		 *** End of saradomin brew fix ( Using noted sara brew on non noted to get non
		 * noted)
		 **/
		/**
		 *** Start of PRAYER POT fix ( Using noted sara brew on non noted to get non
		 * noted)
		 **/
		 ...
		 **/
		/**
		 *** Start of super STRength POT fix ( Using noted sara brew on non noted to get
		 * non noted)
		 **/
		...
		/**
		 *** End of super STRENGTH POTS fix ( Using noted sara brew on non noted to get
		 * non noted)
		 **/
		/**
		 *** Start of super attack pots fix ( Using noted sara brew on non noted to get
		 * non noted)
		 **/
		...
		/**
		 *** End of super ATTACK POTS fix ( Using noted sara brew on non noted to get non
		 * noted)
		 **/
		/**
		 *** Start of super DEFENCE pots fix ( Using noted sara brew on non noted to get
		 * non noted)
		 **/
		...
		/**
		 *** End of super DEFENCE POTS fix ( Using noted sara brew on non noted to get non
		 * noted)
		 **/
		/**
		 *** Start of ranging pots fix ( Using noted sara brew on non noted to get non
		 * noted)
		 **/
		...
		/**
		 *** End of ranging POTS fix ( Using noted sara brew on non noted to get non
		 * noted)
		 **/
		/**
		 *** Start of super restore pots fix ( Using noted sara brew on non noted to get
		 * non noted)
		 **/
		...
		/**
		 *** End of super restore fix ( Using noted sara brew on non noted to get non
		 * noted)
		 **/
		/**
		 *** Start of magic pots fix ( Using noted sara brew on non noted to get non
		 * noted)
		 **/
		...
		if (c.getHerblore().checkItem(useWith, 5) || c.getHerblore().checkItem(itemUsed, 1)
				|| c.getHerblore().checkItem(useWith, 1) || c.getHerblore().checkItem(itemUsed, 5))
			c.getHerblore().handlePotMaking(itemUsed, useWith);
		...
		/**
		 * AUTHOR GABBE (CRETOR OF FORMATIONX) Start of saradomin brew fix ( Using noted
		 * sara brew on non noted to get non noted)
		 **/
