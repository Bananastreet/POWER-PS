...
public class ObjectManager {
	...
	public void Deletewalls(Client c) {
		...
		c.getPA().checkObjectSpawn(-1, 2757, 3498, -1, 10); // new home
}
	...
	/***Project-Nightmare***\
	\***OBJECTMAN***/
	c.getPA().checkObjectSpawn(-1, 2854, 3546, 0, 10); // new hom
	c.getPA().checkObjectSpawn(-1, 2855, 3546, 0, 10); // new hom
				...
				c.getPA().checkObjectSpawn(-1, 3419, 2940, 0, 10);
                c.getPA().checkObjectSpawn(-1, 3280, 9199, 0, 10);				// new hom
	
	
	
	
	c.getPA().checkObjectSpawn(1332, 2680, 3528, 0, 10); // new hom
c.getPA().checkObjectSpawn(1332, 2680, 3526, 0, 10); // new hom
c.getPA().checkObjectSpawn(1332, 2680, 3524, 0, 10); // new hom
c.getPA().checkObjectSpawn(1332, 2680, 3522, 0, 10); // new hom
c.getPA().checkObjectSpawn(1332, 2680, 3520, 0, 10); // new hom
	
	
	c.getPA().checkObjectSpawn(1332, 2680, 3528, 0, 10); // new hom
	c.getPA().checkObjectSpawn(1332, 2678, 3532, 0, 10); // new hom
	c.getPA().checkObjectSpawn(1332, 2676, 3532, 0, 10); // new hom
	c.getPA().checkObjectSpawn(1332, 2674, 3532, 0, 10); // new hom
	c.getPA().checkObjectSpawn(1332, 2672, 3532, 0, 10); // new hom
	
		c.getPA().checkObjectSpawn(1332, 2670, 3532, 0, 10); // new hom
	...
	//home!!!!!!!!!!!!!!!!!!!!!
	c.getPA().checkObjectSpawn(2213, 2876, 3546, 0, 10);//bank
	c.getPA().checkObjectSpawn(2213, 2876, 3547, 0, 10);//Bank
	c.getPA().checkObjectSpawn(2213, 2876, 3545, 0, 10);//Bank
	...
	//	for (int j = 3506; j < 3515; j++) {
			...
			//	for (int j = 3506; j < 3515; j++) {
				...
				c.getPA().checkObjectSpawn(-1, 2679, 3525, 0, 22); // new hom
				c.getPA().checkObjectSpawn(-1, 2677, 3530, 0, 22); // new hom
				c.getPA().checkObjectSpawn(-1, 2671, 3530, 0, 22); // new hom
				c.getPA().checkObjectSpawn(-1, 2679, 3528, 0, 22); // new hom				
				c.getPA().checkObjectSpawn(-1, 2675, 3527, 0, 22); // new hom				
				c.getPA().checkObjectSpawn(-1, 2676, 3527, 0, 22); // new hom	
				c.getPA().checkObjectSpawn(-1, 2676, 3525, 0, 22); // new hom
				c.getPA().checkObjectSpawn(-1, 2674, 3523, 0, 22); // new hom
				c.getPA().checkObjectSpawn(-1, 2672, 3520, 0, 22); // new hom				
				...
				c.getPA().checkObjectSpawn(-1, 2674, 3530, 0, 22); // new hom
			//	for (int j = 3506; j < 3515; j++) {
			...
			//	c.getPA().checkObjectSpawn(-1, 2751, j, 0, 22); // new hom
				...
				c.getPA().checkObjectSpawn(-1, 2856, 3538, 0, 10); // new hom
				c.getPA().checkObjectSpawn(2996, 2856, 3538, 0, 10); //Chest
	//new home
...
c.getPA().checkObjectSpawn(-1, 3900, 3498, -1, 10);
...
c.getPA().checkObjectSpawn(11214, 2976, 9518, 1, 10);// middle down
c.getPA().checkObjectSpawn(11212, 2528, 3091, 0, 10);// middle down
c.getPA().checkObjectSpawn(11209, 2982, 9518, 1, 10);// middle down
...
c.getPA().checkObjectSpawn(13670, 1862, 5345, 3, 10);// middle up
	...
	c.getPA().checkObjectSpawn(13405, 3078, 3506, 3, 10);//Cons-Portal-Skills-Cooking
	...
	c.getPA().checkObjectSpawn(14859, 3056, 9772, 1, 10);//Rune-Ore-Skills-Mining
	c.getPA().checkObjectSpawn(14859, 3056, 9771, 1, 10);//Rune-Ore-Skills-Mining
	c.getPA().checkObjectSpawn(3044, 2040, 4650, 1, 10);//Furnace-Skills-Smithing
	c.getPA().checkObjectSpawn(2783, 3044, 9782, 1, 10);//Anvil-Skills-Smithing
	c.getPA().checkObjectSpawn(2783, 3048, 9782, 1, 10);//Anvil-Skills-Smithing
	c.getPA().checkObjectSpawn(4874, 3098, 3500, 0, 10);//thiev stall  The second value is X COORD and third is Y COORD
	c.getPA().checkObjectSpawn(4875, 3097, 3500, 0, 10);//thiev stall
	c.getPA().checkObjectSpawn(4876, 3096, 3500, 0, 10);//thiev stall
	c.getPA().checkObjectSpawn(4877, 3095, 3500, 0, 10);//thiev stall
	c.getPA().checkObjectSpawn(4878, 3094, 3500, 0, 10);//thiev stall
	...
	c.getPA().checkObjectSpawn(2152, 3082, 3506, 0, 10); //Skills-Oblisk-Summoning

	c.getPA().checkObjectSpawn(2213, 3212, 3432, 0, 10); //Skills-Oblisk-Summoning
	c.getPA().checkObjectSpawn(2213, 3213, 3432, 0, 10); //Skills-Oblisk-Summoning
	c.getPA().checkObjectSpawn(2213, 3214, 3432, 0, 10); //Skills-Oblisk-Summoning
	c.getPA().checkObjectSpawn(2213, 3212, 3426, 0, 10); //Skills-Oblisk-Summoning
	c.getPA().checkObjectSpawn(2213, 3213, 3426, 0, 10); //Skills-Oblisk-Summoning
	c.getPA().checkObjectSpawn(2213, 3214, 3426, 0, 10); //Skills-Oblisk-Summoning
	c.getPA().checkObjectSpawn(13660, 3426, 2916, 0, 10); //Skills-Oblisk-Summoning
	c.getPA().checkObjectSpawn(6282, 3209, 3438, 0, 10); //Skills-Oblisk-Summoning
...
c.getPA().checkObjectSpawn(12355, 3222, 3472, 0, 10);
    ...
    c.getPA().checkObjectSpawn(-1, 3505, 3571, 0, 2);//Remove-Column
...
//dunend         
	  ...
	  /* c.getPA().checkObjectSpawn(-1, 2753, 3500, 0, 10);
		...
		c.getPA().checkObjectSpawn(2996, 2959, 3384, 0, 10);//crystal chest varrock
		c.getPA().checkObjectSpawn(104, 2956, 3384, 0, 10);//naujaschest
		...
		c.getPA().checkObjectSpawn(1332, 2799, 3789, 0, 10); // 
		c.getPA().checkObjectSpawn(1332, 2802, 3786, 0, 10); // 
		c.getPA().checkObjectSpawn(1332, 2789, 3790, 0, 10); // 
		c.getPA().checkObjectSpawn(1332, 2789, 3785, 0, 10); // 
		c.getPA().checkObjectSpawn(1332, 2789, 3781, 0, 10); // 
		c.getPA().checkObjectSpawn(10660, 2790, 3750, 0, 10); //pagrind egle
        c.getPA().checkObjectSpawn(10659, 2794, 3772, 0, 10); // egle		
		...
		c.getPA().checkObjectSpawn(410, 2752, 3495, 0, 10); //lunar altar
		c.getPA().checkObjectSpawn(6552, 2752, 3493, 0, 10); //ancient altar
	...
	//	c.getPA().checkObjectSpawn(11356, 3087, 3483, 0, 10); //Frost drags portal
		...
		c.getPA().checkObjectSpawn(-1, 2845, 3554, 1, 10); 
		c.getPA().checkObjectSpawn(-1, 2845, 3552, 1, 10);  
		c.getPA().checkObjectSpawn(-1, 2845, 3548, 1, 10);  
		c.getPA().checkObjectSpawn(-1, 2847, 3548, 1, 10); 
		c.getPA().checkObjectSpawn(-1, 2845, 3551, 1, 10); 
		c.getPA().checkObjectSpawn(-1, 2846, 3554, 1, 10); 
		c.getPA().checkObjectSpawn(-1, 2847, 3555, 1, 10); 
		c.getPA().checkObjectSpawn(-1, 2851, 3551, 1, 10); 
		c.getPA().checkObjectSpawn(-1, 2850, 3553, 1, 10); 
		c.getPA().checkObjectSpawn(-1, 2850, 3552, 1, 10); 
		c.getPA().checkObjectSpawn(-1, 2841, 3550, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2841, 3552, 1, 10); 
		c.getPA().checkObjectSpawn(-1, 2841, 3553, 1, 10); 
		c.getPA().checkObjectSpawn(-1, 2839, 3554, 1, 10); 
		c.getPA().checkObjectSpawn(-1, 2839, 3553, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2841, 3551, 1, 10); 		
		c.getPA().checkObjectSpawn(-1, 2839, 3550, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2839, 3551, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2839, 3552, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2843, 3550, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2843, 3553, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2843, 3554, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2843, 3551, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2843, 3548, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2855, 3546, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2834, 3546, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2857, 3536, 1, 10); 	
		c.getPA().checkObjectSpawn(-1, 2851, 3536, 1, 10); 		
		//c.getPA().checkObjectSpawn(2286, 2598, 4778, 1, 10);
		c.getPA().checkObjectSpawn(409, 2838, 3553, 1, 10);
		c.getPA().checkObjectSpawn(410, 2842, 3550, 1, 10);
		c.getPA().checkObjectSpawn(411, 2843, 3553, 1, 10);
		c.getPA().checkObjectSpawn(6552, 2838, 3550, 1, 10);
		...
		c.getPA().checkObjectSpawn(13660, 2965, 3386, 0, 10); //Pokeball
